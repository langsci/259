...
based on HPSG are used. We first consider applications furthering
linguistic research, including both language documentation and
linguistic hypothesis testing. As decribed in
\citealt{Mueller99a-Short,Bender2008c-Short} and \citealt{BFO2011a-u},
...
a meta-grammar, like the Grammar Matrix customization system (see Section~\ref{cl:gmcs}), but for a single language. This customization system maintains
