...
Not just practical, also theoretical:
developing multiple grammars in parallel,
improving analyses by cross-linguistic comparison.

Testsuites with tsdb++,
...
Top-most constraint set: hypothesis about properties shared by all languages.
Includes:
connection between syntax and information structure,
allows V2 but rules out V-penultimate.
...
\citet{reiplinger2012glossary} aim to identify definitions of technical concepts,
...
semantic dependency graphs can provide a useful tool.
\citet{oepen2017extrinsic} present a shared task,
