...
development for 8 years, and the \isi{Verbmobil} project
...
Some participating teams use DM\is{\delphin\ MRS Dependencies (DM)} dependencies%\footnote{DM \delphin\ MRS dependencies; see (\ref{cl:fig:dm}).} 
