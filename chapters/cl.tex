...
\citet{MuellerCoreGram} describes this as a ``bottom-up approach with cheating''
-- the aim is to analyse each language on its own terms (hence ``bottom-up''),
...
\citep[see also section~\ref{cl:treebanks} below]{OFTM2004a-u,Packard:15}, 
and parse ranking models trained on them
\citep[see also section~\ref{cl:prac:rank} above]{Tou:Man:Fli:Oep:05}, and
...
\subsubsection{Derived resources: Treebanks}
\label{cl:treebanks}
%Emily

Redwoods-style treebanks
