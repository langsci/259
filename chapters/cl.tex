...
(for an overview, see \crossrefchapteralt{chapters/evolution}).
...
while \isi{semantic roles} and scopal\is{scope} constraints are represented as dependencies.
...
Finally, (\ref{cl:fig:dm}) shows the corresponding \delphin\ MRS Dependencies (DM) representation.\is{\delphin\ MRS Dependencies (DMRS)}
...
as well as software packages to manipulate such graphs (\eg\ \citealt{copestake2016pydmrs}, \citealt{Her:Kuh:Oep:19}, or \isi{PyDelphin}\footnote{\url{https://github.com/delph-in/pydelphin/}, accessed 16 August 2019}}),
