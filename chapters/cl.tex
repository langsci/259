...
Ambituity in modifier attachment, part of speech assignment, and the
like are well-known in linguistics, such that examples like
\rref{cl:ambig-telescope} are stock in trade:
...
The \delphin\footnote{This acronym stands for DEep Linguistic
  Processing in HPSG INitiative; see \url{www.delph-in.net}} Consortium
...
pratical applications. At the time that \delphin\ was founded, the
...
variable phenomena
\citep[\eg][]{Drellishak2009a-u,Ben:Dre:Fok:Pou:Sal:10}.
...
\citep[see also \S\ref{cl:treebanks} below]{OFTM2004a-u,Packard:15}, 
and parse ranking models trained on them
\citep[see also \S\ref{cl:prac:rank} above]{Tou:Man:Fli:Oep:05}, and
...
\citep{FIXME}, and file formats for the storage and interchannge of
...
bulk grammar output \citep{Oepen:01,FIXME-art,FIXME-pyDelphin}, and of
multilingual downstream systems which can be adapted to additional
languages by plugging in different grammars.

The \delphin\ community maintains research interests in both
linguistics an practical applications. The focus on linguistics means
...
performance innovations, such as supertagging or ubertagging to speech
...
analyzers, named entity recognizers; (4) parse and realization
...
From a linguistic point of view, these efforts
are also valuable. First, the broader/more robust the coverage of
a grammar is, the more linguistic phenomena it can be used to explore.
...
\cite{BFO2002a-u,Ben:Dre:Fok:Pou:Sal:10} was initially developed in
...
that of CoreGram (see \S\ref{cl:coregram}): in the typical use case,
...
each other. This is cross-linguistic analogue of how monolingual
...
as yet not well-understood.\footnote{This methodology of using an
  ...
  of corpora is demonstrated for English by \cite{Baldwin-et-al-04}.}
...
\S\ref{cl:treebanks} below). However, the process of building an
...
* Morphotactics
* High-level properties (case system, word order)
* End-to-end prototype for one language merging those all
...
%%         Cited = {Kaufmann2009 Diss, Check: Ulrich Schmitz, 1997 [mit Elisabeth
%% Cölfen/ Hermann Cölfen:] Linguistik im Internet. Das Buch zum Netz - mit
%% CD-ROM. Opladen: Westdeutscher Verlag},
%%         Date-Modified = {2017-06-18 09:15:51 +0000},
...
%%         Author = {Stefan Müller},
%%         Cited = {KaySag2009, Bender2008: Wambaya, Michael W. Daniels and W.
%% Detmar Meurers: GIDLP: A Grammar Format For Linearization-based HPSG,
%% HPSG 2004},
%%         Date-Modified = {2014-03-25 14:36:04 +0000},
...
%% The grammar and phenomena are documented in my thesis:
