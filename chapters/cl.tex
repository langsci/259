...
Rather than considering all possible lexical entries for each token
(which leads to high levels of ambiguity),
supertagging aims to choose the correct lexical entry for each token,
