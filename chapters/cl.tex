...
(for an overview, see \crossrefchapter{chapters/evolution}).
...
as this enables the use of graph-based algorithms.\footnote{%
	...
	For \emph{syntactic} dependencies,\is{dependencies!syntactic} see \crossrefchaptert{dg}.
...
(for details, see \citealt{CFPS2005a} or \crossrefchapter{semantics}).
...
as well as software packages to manipulate such graphs (\eg\ \citealt{copestake2016pydmrs}, \citealt{Her:Kuh:Oep:19}, or PyDelphin\footnote{\url{https://github.com/delph-in/pydelphin/}, accessed 16 August 2019}}),
...
\crossrefchapterp[see also]{order}.
It also includes constraints for argument structure and linking
\crossrefchapterp[see]{arg-st},
as well as for information structure
\crossrefchapterp[see]{information-structure}.
