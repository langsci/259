...
DMRS:
\citet{buys2017parse} -- accuracy almost as good, much faster, full coverage.
\citet{chen2018parse} -- accuracy on par.
...
Exploit semantic representations in a treebank.
