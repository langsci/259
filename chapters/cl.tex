...
\begin{subfigure}{\textwidth}
	...
	\begin{align*}
		...
		l_5 &: \textit{\_blossom\_v\_1}(e_1,x_1)
	\end{align*}
	\caption{MRS, abstractly}
\end{subfigure}
\begin{subfigure}{\textwidth}
	\centering
	\begin{tikzpicture}[node distance=12mm and 20mm, inner sep=2mm, thick]
		...
		\draw[->] (cm) -- (ch) node[midway, above, xshift=1mm] {\textsc{arg2/neq}};
		\draw[->] (cm) -- (tr) node[midway, above, xshift=-1mm] {\textsc{arg1/eq}};
		\draw[->] (b) -- (tr) node[midway, above, xshift=1mm] {\textsc{arg1/neq}};
...
\end{subfigure}
\caption{%
	Comparison of MRS, DMRS, and DM,
	for the sentence ``the cherry tree blossomed''.
