...
\ChapterDOI{10.5281/zenodo.13645044}
...
For~\rref{cl:ex:ambig-many}, the first line of a newspaper article,\footnote{%
	\url{https://www.theguardian.com/science/2018/aug/22/offspring-of-neanderthal-and-denisovan-identified-for-first-time}, accessed 2024-10-13.}
...
as well as \isi{software} packages to manipulate such graphs (\eg\ \citealt{ivanova2012dm}, \citealt{copestake2016pydmrs}, \citealt{Her:Kuh:Oep:19}, or \isi{PyDelphin}\footnote{\url{https://github.com/delph-in/pydelphin/}, accessed 2024-10-13.}),
...
The CoreGram\footnote{
	\url{https://hpsg.hu-berlin.de/Projects/CoreGram.html}, accessed 2024-10-13.
...
The \delphin\footnote{\delphin\ stands for DEep Linguistic Processing in \textsc{Hpsg} INitiative;
  see \url{http://www.delph-in.net}, accessed 2024-10-13.} Consortium was established in 2001 to
...
\isi{ACE},\footnote{\url{http://sweaglesw.org/linguistics/ace/}, accessed 2024-10-13.}  and
...
like \itsdb \citep{Oepen:01}, \is{art
  ...
  2024-10-13.} and \isi{PyDelphin}\footnote{\url{https://github.com/delph-in/pydelphin/}, accessed
  2024-10-13.};
...
\is{Alpino|(}%
Alpino\footnote{%
	\url{http://www.let.rug.nl/vannoord/alp/Alpino/}, accessed 2024-10-13.
}
...
\is{Enju|(}%
Enju\footnote{%
	\url{http://www.nactem.ac.uk/enju/}, accessed 2024-10-12.
} \citep{MNT2005a-u}
...
AGGREGATION\footnote{\url{http://depts.washington.edu/uwcl/aggregation/}, accessed 2024-10-13.}
...
Finally, there are also automatically annotated\is{annotation!automatic} treebanks, which use a statistical parse-ranking model to select the best parse, instead of using a human annotator.  These are not as reliable as manually annotated treebanks, but they can be considerably larger.  \isi{WikiWoods}\footnote{\url{http://moin.delph-in.net/WikiWoods}, accessed 2024-10-13.}  covers 55 million sentences of \ili{English} (900 million tokens).  It was produced by \citet{flickinger2010wikiwoods} and \citet{solberg2012wikiwoods} from the July 2008 dump of the full \ili{English} \isi{Wikipedia}, using the ERG and PET, with parse ranking trained on the manually treebanked subcorpus \isi{WeScience} \citep{ytrestol2009wescience}.  As with the \isi{Redwoods} treebanks, WikiWoods is updated with each release of the ERG.%
%
\is{treebank|)}%
\is{sembank|)}%
%
...
cover situations where a grammar is used to provide data for machine learning systems.\footnote{The
  ...
  resources at \url{http://moin.delph-in.net/DelphinApplications} (accessed 2024-10-13).}
