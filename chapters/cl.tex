...
The \delphin\footnote{This acronym stands for DEep Linguistic
  Processing in \textsc{Hpsg} INitiative; see \url{www.delph-in.net}} Consortium
...
bulk grammar output \citep{Oepen:01,FIXME-art,FIXME-PyDelphin},\footnote{%
...
as yet not well-understood.\footnote{This methodology of using an
  ...
  of corpora is demonstrated for English by \cite{Baldwin-et-al-04,Baldwin-et-al-05}.}
