...
\noindent 
For nominals the value of the \textsc{content} feature is of type \type{scope-obj(ect)} 
in \citet{GS00}. 
...
\type{semantic-obj(ect)}.\footnote{In \citet[45]{ps2} the \textsc{spec(ified)}
...
by the \textsc{mark(ing)} feature. It is declared for objects of type \type{category}, 
...
called \textsc{sel(ect)}, and its value is an object of type \type{synsem} that is 
...
[{[\textsc{head} ~ \avmbox{1} [\type{noun} \textsc{sel} ~ \type{none}], \textsc{mark} ~ \avmbox{2} \type{marked}]}
	[{[\textsc{head} ~ [\type{pron} \textsc{sel} ~ \avmbox{4}], \textsc{mark} ~ \avmbox{2}]} [that]]
	[{\avmbox{4} [\textsc{head} ~ \avmbox{1}, \textsc{mark} ~ \avmbox{5} \type{unmarked}]}
		[{[\textsc{head} ~ [\type{adj} \textsc{sel} ~ \avmbox{3}], \textsc{mark} ~ \avmbox{5}]} [long]]
...
[{[\textsc{head} ~ \avmbox{1} [\type{noun} \textsc{sel} ~ \type{none}], \textsc{mark} ~ \avmbox{2} \type{marked}]}
	...
	[{\avmbox{4} [\textsc{head} ~ \avmbox{1}, \textsc{comps} ~ \liste{(PP[\type{by}]$_{i}$)}, \textsc{mark} ~ \avmbox{5} \type{unmarked}]}
		[{[\textsc{head} ~ \avmbox{1}, \textsc{comps} ~ \liste{ (PP[\type{by}]$_{i}$), \avmbox{3}}, \textsc{mark} ~ \avmbox{5}]} [description]]
		[{\avmbox{3} [\textsc{head} ~ \type{prep}, \textsc{comps} ~ \eliste]} [of the Hungarian NP, roof]]]]
	\end{forest}
}
...
\oneline{%
	\begin{forest}
sm edges
[{[\textsc{head} ~ \avmbox{5} [\type{noun} \textsc{sel} ~ \type{none}], \textsc{mark} ~ \avmbox{1}]}
	[{[\textsc{head} ~ \avmbox{4} [\type{noun} \textsc{sel} ~ \avmbox{2}], \textsc{mark} ~ \avmbox{1}]}
		[{[\textsc{head} ~ [\type{pron} \textsc{sel} ~ \avmbox{3}], \textsc{mark} ~ \avmbox{1} \type{marked}]} [a]]
		[{\avmbox{3} [\textsc{head} ~ \avmbox{4}, \textsc{mark} ~ \type{unmarked}]} [hundred]]]
	[{\avmbox{2} [\textsc{head} ~ \avmbox{5}, \textsc{mark} ~ \type{unmarked}]} [pages]]]
	\end{forest}
}
...
Nominals without specifier have a \textsc{marking} value of type \type{unmarked}. 
...
\begin{exe} 
\ex\label{maj} In a lexical category of type \type{func-cat} the value of its \textsc{major} 
...
\begin{figure}
	...
	\begin{forest}
sm edges
[{[\textsc{head} ~ $\avmbox{3}$ \type{noun}, \textsc{mark} ~ $\avmbox{1}$ \type{a}]}
		[{[\textsc{mark} ~ $\avmbox{1}$, \textsc{sel} ~ $\avmbox{2}$]} [a]]
		[{$\avmbox{2}$ [\textsc{head} ~ $\avmbox{3}$, \textsc{mark} ~ \type{unmarked}]} [bargain]]]
	\end{forest}
...
The article has a \textsc{marking} value of type \emph{a} which is a subtype of \type{marked} and which it
...
whose \textsc{marking} value is \type{a}, and the non-head daughter 
...
\type{de} and shares its own \textsc{marking} value with the NP as a whole. 
...
sm edges
[{[\textsc{head} ~ \avmbox{1} \type{noun}[\textsc{sel} ~ \type{none}], \textsc{mark} ~ \avmbox{2} \type{marked}]}
	[{[\textsc{head} ~ [\type{adv} \textsc{sel} ~ \avmbox{4}], \textsc{mark} ~ \avmbox{2}]} [beaucoup]]
	[{\avmbox{4} [\textsc{head} ~ \avmbox{1}, \textsc{mark} ~ \avmbox{5} \type{de}]}
		[{[\textsc{head} ~ [\type{prep} \textsc{sel} ~ \avmbox{3}], \textsc{mark} ~ \avmbox{5}]} [de]]
