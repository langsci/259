...
as unification, inheritance and token-identity; see \crossrefchaptert{formal-background} 
...
is subsumed by the \type{head-complements-phrase} type \crossrefchapterp{properties}, 
...
See \citet[34]{ps2} and \crossrefchaptert{properties}.
...
definition of the type \type{head-adjunct-phrase} \crossrefchapterp{properties}. 
...
instance of concord \crossrefchapterp{agreement}.}  
...
is called \emph{index agreement} \crossrefchapterp{agreement}.
...
\emph{red} in (\ref{reddd}) \citep[55]{ps2}.\footnote{Boxed \ili{Greek} capitals
...
the sementic content of the nominal by means of \textsc{spec}.  
...
\avm{[head \1 \type{noun}, spr < >]}
	[%
	\avm{\2 [head \3 \type{det}, spr < >]}
		[%
		\avm{\4 [head \type{noun}, spr < >]}
...
sm edges
[%
\avm{[head \1 \type{det}, comps < >]}
	[%
	\avm{[head \1, comps < \4 NP >]}
		[that]
	]
	[%
	\avm{\4 [head \2 \type{noun}, comps < >]}
		[%
		\avm{[head \2, comps < \3 >]}
			[sister]
		]
...
\avm{[major \1, minor \2]}
	[%
	\avm{[major \1, minor \2 fcompl $+$]}
		[that]
	]
	[%
	\avm{[major \1 [$-$V, $+$N[\type{sing}]], minor|fcompl $-$]}
...
\ex
\gll onze muur     \\
     our wall.\textsc{sg.masc}  \\
\ex
\gll ons huis     \\
     our house.\textsc{sg.neut}  \\
\end{xlist}
\ex\label{welk}
\begin{xlist} 
\ex
...
\ex
\gll welke man                 \\
     which man.\textsc{sg.masc}  \\
\ex
\gll welk boek   \\
     which book.\textsc{sg.neut} \\
\end{xlist}
\end{exe} 
...
\ex
\gll  wiens muur \\ 
      whose wall.\textsc{sg.masc} \\
\ex
\gll  wiens huis \\ 
      whose house.\textsc{sg.neut} \\
\end{xlist}
\ex\label{wat}
\begin{xlist}
\ex
...
\ex 
\gll  il loro futuro \\   
      the their future.\textsc{sg.masc}  \\ 
\ex 
\gll  la loro scuola  \\   
      the their school.\textsc{sg.fem}   \\ 
\ex 
\gll  i loro genitori \\   
      the their parent.\textsc{pl.masc} \\ 
\ex 
\gll  le loro scatole \\   
...
\avm{
[\punk{synsem|loc|category|marking}{ \1 marking}  \\
...
sm edges
[%
\avm{[head \1 \type{noun}, mark \2 \type{marked}]}
	[%
	\avm{[head|sel \4, mark \2]}
		[that]
	]
	[%
	\avm{\4 [head \1, mark \5 \type{unmarked}]}
		[%
		\avm{[head|sel \3, mark \5]}
			[long]
		]
		[%
		\avm{\3 [head \1, mark \5]}
...
sm edges
[%
\avm{[head \1 \type{noun}, mark \2]}
	[%
	\avm{[head \4 \type{noun} [sel \3], mark \2]}
		[%
		\avm{[head|sel \5, mark \2 \type{marked}]}
			[a]
		]
		[%
		\avm{\5 [head \4, mark \type{unmarked}]}
			[hundred]
		]
	]
	[%
	\avm{\3 [head \1, mark \type{unmarked}]}
		[pages]
	]
]
\end{forest}}
...
sm edges
[%
\avm{[head \1 \type{noun}, mark \2 \type{a}]}
	[%
	\avm{[head|sel \3, mark \2]}
		[a]
	]
	[%
	\avm{\3 [head \1, mark \type{unmarked}]}
...
sm edges
[%
\avm{[head \3 \type{adj}, mark \1 \type{marked}]}
	[%
	\avm{[head|sel \2, mark \1]}
		[so]
	]
	[%
	\avm{\2 [head \3, mark \type{unmarked}]}
		[good]
	]
]
\end{forest}
...
[\punk{synsem|loc}{	[\punk{category|head}{ noun} \\
					content &	[\type*{parameter}
								index & \1 \\
								restr & \tag{$\Sigma_1$} $\cup$ \tag{$\Sigma_2$}] ]} \\
 dtrs & <[synsem|loc|content|restr \tag{$\Sigma_1$} ], \2> \\
...
\avm{[head \1 \type{noun}, mark \2 \type{marked}]}
	[%
	\avm{[head|sel \4, mark \2]} [beaucoup;much]]
	[%
	\avm{\4 [head \1, mark \5 \type{de}]}
		[%
		\avm{[head|sel \3, mark \5]} [de;of]]
		[%
		\avm{\3 [head \1, mark \type{bare}]}
			[farine;flour]
		]
	]
]
