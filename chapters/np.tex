...
a relational noun, such as \emp{sister}, selects a PP as its complement 
...
\begin{exe}
\ex\label{hefu} 
\type{head-functor-phrase} ~ $\Rightarrow$ ~ 
\begin{avm}
...
\begin{exe}
\ex\label{hein} 
\type{head-independent-phrase} ~ $\Rightarrow$ ~ 
\begin{avm}
...
\begin{exe}
\ex\label{acccx} 
\type{nonfin-head-subj-cx} ~ $\Rightarrow$ ~ 
\begin{avm} 
...
\begin{exe}
\ex\label{param} 
\type{nominal-parameter} ~ $\Rightarrow$ ~
\begin{avm}
[synsem|loc [category|head \type{noun}                              \\
...
\begin{exe}
\ex\label{mononom} 
\type{intersective-modification} ~ $\Rightarrow$ ~ 
\begin{avm}
