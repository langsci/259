...
is subsumed by the \type{head-comp(lement)s-phr} type, as defined in 
...
is subsumed by the \type{head-sp(ecifie)r-phr} type, as defined in Chapter 1 of this Volume, 
%\crossrefchaptert{basic-properties}. 
...
\footnotesize
\tree
{\ntnode{Za}{[{\sc head} ~ \avmbox{1} \type{noun} , {\sc spr} ~ $<$ ~ $>$ , {\sc comps} ~ $<$ ~ $>$]},
  {\ntnode{Zd}{\avmbox{2}},
    {\tnode{Ze}{that}}},
...
definition of type \type{head-adj(unct)-phr}, as defined in 
%\crossrefchaptert{basic-properties}
Chapter 1 of this Volume. 
...
\footnotesize
\tree
{\ntnode{Za}{[{\sc head} ~ \avmbox{1} \type{noun} , {\sc spr} ~ $<$ ~ $>$]},
  {\ntnode{Zd}{\avmbox{2}},
    {\tnode{Ze}{that}}},
  {\ntnode{Zf}{[{\sc head} ~ \avmbox{1} , {\sc spr} ~ $<$\avmbox{2}$>$]},
    {\ntnode{Zl}{[{\sc head} ~ \avmbox{4}]},
      {\ntnode{Zu}{[{\sc head} ~ \type{adv}]},
        {\tnode{Zv}{very}}},
      {\ntnode{Zw}{[{\sc head} ~ \avmbox{4} [\type{adj} {\sc mod} ~ \avmbox{3}]]},
        {\tnode{Zm}{tall}}}},
...
\tree
  {\ntnode{Za}{[{\sc head} ~ \avmbox{1} \type{noun} , {\sc spr} ~ $<$ ~ $>$]},
    {\ntnode{Zd}{\avmbox{2} [{\sc head} ~ \avmbox{3} \type{det} , {\sc spr} ~ $<$ ~ $>$]},
      {\ntnode{Zf}{\avmbox{4} [{\sc head} ~ \type{noun} , {\sc spr} ~ $<$ ~ $>$]},
...
\begin{center} 
\footnotesize
\tree   {\ntnode{Zi}\type{headed-phr},
          {\ntnode{Zv}\type{head-arg-phr}, 
            {\tnode{Zq}{head-subj-phr}},
            {\tnode{Zl}{head-comps-phr}},
            {\tnode{Zg}{...}}},
          {\ntnode{Zw}\type{head-nonarg-phr}, 
...
\footnotesize
\tree
{\ntnode{Zz}{[{\sc head} ~ \avmbox{1} [\type{noun} {\sc sel} ~ \type{none}] , {\sc mark} ~ \avmbox{2} \type{marked}]},
  {\ntnode{Za}{[{\sc head} ~ [\type{pron} {\sc sel} ~ \avmbox{4}] , {\sc mark} ~ \avmbox{2}]},
    {\tnode{Zp}{that}}},
  {\ntnode{Zb}{\avmbox{4} [{\sc head} ~ \avmbox{1} , {\sc mark} ~ \avmbox{5} \type{unmarked}]},
    {\ntnode{Zc}{[{\sc head} ~ [\type{adj} {\sc sel} ~ \avmbox{3}] , {\sc mark} ~ \avmbox{5}]},
      {\tnode{Zq}{long}}},  
...
\tree
{\ntnode{Zz}{[{\sc head} ~ \avmbox{1} [\type{noun} {\sc sel} ~ \type{none}] , {\sc mark} ~ \avmbox{2} \type{marked}]},
  {\ntnode{Za}{[{\sc head} ~ [\type{pron} {\sc sel} ~ \avmbox{4}] , {\sc mark} ~ \avmbox{2}]$_{i}$},
    {\tnode{Zp}{his}}},
  {\ntnode{Zb}{\avmbox{4} [{\sc head} ~ \avmbox{1} , {\sc comps} ~ $<$(PP[\type{by}]$_{i}$)$>$ , {\sc mark} ~ \avmbox{5} \type{unmarked}]},
    {\ntnode{Zc}{[{\sc head} ~ \avmbox{1} , {\sc comps} ~ $<$ (PP[\type{by}]$_{i}$) , \avmbox{3}$>$ , {\sc mark} ~ \avmbox{5}]},
      {\tnode{Zq}{description}}},  
    {\ntnode{Zd}{\avmbox{3} [{\sc head} ~ \type{prep} , {\sc comps} ~ $<$ ~ $>$]},
...
\scriptsize
\tree
  {\ntnode{Za}{[{\sc head} ~ \avmbox{5} [\type{noun} {\sc sel} ~ \type{none}] , {\sc mark} ~ \avmbox{1}]},
    {\ntnode{Zd}{[{\sc head} ~ \avmbox{4} [\type{noun} {\sc sel} ~ \avmbox{2}] , {\sc mark} ~ \avmbox{1}]},
      {\ntnode{Zf}{[{\sc head} ~ [\type{pron} {\sc sel} ~ \avmbox{3}] , {\sc mark} ~ \avmbox{1} \type{marked}]},
        {\tnode{Zl}{a}}},
      {\ntnode{Zg}{\avmbox{3} [{\sc head} ~ \avmbox{4} , {\sc mark} ~ \type{unmarked}]},
        {\tnode{Zi}{hundred}}}},
    {\ntnode{Zk}{\avmbox{2} [{\sc head} ~ \avmbox{5} , {\sc mark} ~ \type{unmarked}]},
      {\tnode{Zh}{pages}}}}
\nodeconnect{Za}{Zd}
\nodeconnect{Za}{Zk}
\nodeconnect{Zd}{Zf}
...
\footnotesize
\tree
{\ntnode{Zz}\type{marking},
  {\ntnode{Ze}\type{unmarked},  
    {\tnode{Zf}{incomplete}},
    {\tnode{Zg}{bare}}},
  {\tnode{Zh}\type{marked}}}
\nodeconnect{Zz}{Ze}
...
\footnotesize
\tree
{\ntnode{Za}{[{\sc head} ~ \avmbox{1} \type{det} , {\sc comps} ~ $<$ ~ $>$]},
  {\ntnode{Zd}{[{\sc head} ~ \avmbox{1} , {\sc comps} ~ $<$\avmbox{4} NP$>$]},
    {\tnode{Ze}{that}}},
  {\ntnode{Zf}{\avmbox{4} [{\sc head} ~ \avmbox{2} \type{noun} , {\sc comps} ~ $<$ ~ $>$]},
...
\begin{exe} 
\ex  \type{part-of-speech}: \begin{avm}
                              [major [n ~ \type{boolean} \\
                                      v ~ \type{boolean} ] \\
...
\footnotesize
\tree
{\ntnode{Za}{[{\sc major} ~ \avmbox{1} [--V, +N[\type{sing}]] , {\sc minor$|$fcompl} ~ +]},
...
\begin{center}
\tree
{\ntnode{Zd}{[{\sc head} ~ $\avmbox{3}$ \type{noun} , {\sc mark} ~ $\avmbox{1}$ \type{a}]},    
  {\ntnode{Ze}{[{\sc mark} ~ $\avmbox{1}$ , {\sc sel} ~ $\avmbox{2}$]},    
    {\tnode{Zl}{a}}},
  {\ntnode{Zg}{$\avmbox{2}$ [{\sc head} ~ $\avmbox{3}$ , {\sc mark} ~ \type{unmarked}]},
    {\tnode{Zi}{bargain}}}}
\nodeconnect{Zd}{Ze}
\nodeconnect{Ze}{Zl}
\nodeconnect{Zd}{Zg}
...
\begin{center}
\tree
{\ntnode{Zd}{[{\sc head} ~ $\avmbox{3}$ \type{adj} , {\sc mark} ~ $\avmbox{1}$ \type{marked}]},
  {\ntnode{Ze}{[{\sc mark} ~ $\avmbox{1}$ , {\sc sel} ~ $\avmbox{2}$]},    
    {\tnode{Zl}{so}}},
  {\ntnode{Zg}{$\avmbox{2}$ [{\sc head} ~ $\avmbox{3}$ , {\sc mark} ~ \type{unmarked}]},
    {\tnode{Zi}{good}}}}
...
\tree
    {\ntnode{Zj}\type{phrase},
      {\ntnode{Zl}{{\sc headedness}}, 
        {\ntnode{Zh}\type{headed-phr},
          {\ntnode{Zr}\type{hd-nonargument-phr},
            {\ntnode{Zx}\type{hd-functor-phr},
              {\tnode{Zp}{regular-nominal-phr}}}, 
            {\ntnode{Zt}\type{hd-independent-phr}}}}},
      {\ntnode{Zg}{{\sc clausality}},
        {\ntnode{Zk}\type{non-clause},
          {\ntnode{Zs}\type{nominal-parameter},
...
\footnotesize
\tree
{\ntnode{Zz}\type{part-of-speech},
  {\ntnode{Ze}\type{noun},  
    {\tnode{Zf}{proper-noun}},
    {\tnode{Zg}{common-noun}}, 
    {\tnode{Zw}{gerund}}},
  {\ntnode{Zh}\type{relational},
    {\tnode{Zj}{verb}},      
    {\tnode{Zk}{adjective}}}}
\nodeconnect{Zz}{Ze}
\nodeconnect{Ze}{Zf}
...
\tree
    {\ntnode{Zj}\type{phrase},
      {\ntnode{Zh}{{\sc headedness}}, 
        {\ntnode{Zi}\type{headed-phr},
          {\ntnode{Zo}\type{head-subj-phr},
            {\tnode{Zs}{nonfin-head-subj-cx}}}, 
          {\ntnode{Zp}\type{head-spr-phr},
            {\tnode{Zz}{noun-poss-cx}}}, 
          {\tnode{Zq}{...}}}},
     {\ntnode{Zl}{{\sc clausality}}, 
        {\ntnode{Zx}\type{clause}},
        {\ntnode{Zy}\type{non-clause}}}}
\nodeconnect{Zj}{Zh}
\nodeconnect{Zh}{Zi}
\nodeconnect{Zj}{Zl}
\nodeconnect{Zl}{Zx}
...
\footnotesize
\tree
{\ntnode{Za}{[{\sc head} ~ \avmbox{1} \type{noun} , {\sc comps} ~ $<$ ~ $>$]},
  {\ntnode{Zd}{N},
    {\tnode{Ze}{het}}},
  {\ntnode{Zb}{[{\sc head} ~ \avmbox{1} , {\sc comps} ~ $<$ ~ $>$]},
    {\ntnode{Zf}{[{\sc head} ~ \avmbox{1} , {\sc comps} ~ $<$\avmbox{2} PP$_{j}$$>$]},
      {\ntnode{Zg}{[{\sc head} ~ \avmbox{4} \type{verb} , {\sc comps} ~ $<$NP$_{j}$$>$]},
        {\ntnode{Zl}{\avmbox{3}},
          {\tnode{Zm}{op diepte}}},
        {\ntnode{Zi}{[{\sc head} ~ \avmbox{4} , {\sc comps} ~ $<$NP$_{j}$ , \avmbox{3} PP_{k}$>$]},
          {\tnode{Zj}{houden}}}}},
    {\ntnode{Zk}{\avmbox{2}}, 
...
\tree
   {\ntnode{Zj}\type{phrase},
     {\ntnode{Zh}{{\sc headedness}}, 
        {\ntnode{Zi}\type{non-headed-phr},
          {\tnode{Zo}{coord-phr}},
          {\ntnode{Zp}\type{convert-phr},
            {\tnode{Zz}{nom-inf-phr}}}, 
          {\tnode{Zq}{...}}}},
     {\ntnode{Zl}{{\sc clausality}}, 
       {\tnode{Zx}{clause}},
...
\tree
{\ntnode{Zz}{[{\sc head} ~ \avmbox{1} \type{noun}[{\sc sel} ~ \type{none}] , {\sc mark} ~ \avmbox{2} \type{marked}]},
  {\ntnode{Za}{[{\sc head} ~ [\type{adv} {\sc sel} ~ \avmbox{4}] , {\sc mark} ~ \avmbox{2}]},
    {\tnode{Zp}{beaucoup}}},
  {\ntnode{Zb}{\avmbox{4} [{\sc head} ~ \avmbox{1} , {\sc mark} ~ \avmbox{5} \type{de}]},
    {\ntnode{Zc}{[{\sc head} ~ [\type{prep} {\sc sel} ~ \avmbox{3}] , {\sc mark} ~ \avmbox{5}]},
      {\tnode{Zq}{de}}},  
    {\ntnode{Zd}{\avmbox{3} [{\sc head} ~ \avmbox{1} , {\sc mark} ~ \type{bare}]},
      {\tnode{Zh}{farine}}}}}
\nodeconnect{Zz}{Za}
\nodeconnect{Zz}{Zb}
\nodeconnect{Za}{Zp}
