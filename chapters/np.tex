...
An illustration of the functor treatment is given in Figure~\ref{markyy}.\inlinetodostefan{add a more
  telling title. What is the functor?}
\begin{figure}
\centering
\oneline{%
\begin{forest}
...
the surface-oriented monostratal character of HPSG than the DP treatment.\inlinetodostefan{Add: As for now
  there is no worked out analysis of the semantics of functor-based analyses.}
