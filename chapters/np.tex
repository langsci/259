...
\begin{figure}
	...
	\begin{forest}
sm edges
[{[{\sc head} ~ \avmbox{1} \type{noun} , {\sc spr} ~ $<$ ~ $>$ , {\sc comps} ~ $<$ ~ $>$]}
		[\avmbox{2} [that]]
		[{[{\sc head} ~ \avmbox{1} , {\sc spr} ~ $<$\avmbox{2}$>$ , {\sc comps} ~ $<$ ~ $>$]} 
			[{[{\sc head} ~ \avmbox{1} , {\sc spr} ~ $<$\avmbox{2} Det$>$ , {\sc comps} ~ $<$\avmbox{3} PP$>$]} [sister]]
...
\begin{figure}
	...
	\begin{forest}
sm edges
[{[{\sc head} ~ \avmbox{1} \type{noun} , {\sc spr} ~ $<$ ~ $>$]}
	[\avmbox{2} [that]]
	[{[{\sc head} ~ \avmbox{1} , {\sc spr} ~ $<$\avmbox{2}$>$]}
		[{[{\sc head} ~ \avmbox{4}]}
			[{[{\sc head} ~ \type{adv}]} [very]]
			[{[{\sc head} ~ \avmbox{4} [\type{adj} {\sc mod} ~ \avmbox{3}]]} [tall]]]
		[{\avmbox{3} [{\sc head} ~ \avmbox{1} , {\sc spr} ~ $<$\avmbox{2} Det$>$]} , before drawing tree={x+=2em} [sister of Leslie, roof, before drawing tree={x+=2em}]]]]
	\end{forest}
...
sm edges
[{[{\sc head} ~ \avmbox{1} \type{noun} , {\sc spr} ~ $<$ ~ $>$]}
	[{\avmbox{2} [{\sc head} ~ \avmbox{3} \type{det} , {\sc spr} ~ $<$ ~ $>$]}
		[{\avmbox{4} [{\sc head} ~ \type{noun} , {\sc spr} ~ $<$ ~ $>$]} [the Queen of England, roof]]
		[{[{\sc head} ~ \avmbox{3} , {\sc spr} ~ $<$\avmbox{4}$>$]} ['s]]]
	[{[{\sc head} ~ \avmbox{1} , {\sc spr} ~ $<$\avmbox{2}$>$]} [sister]]]
	\end{forest}
...
[{[{\sc head} ~ \avmbox{1} [\type{noun} {\sc sel} ~ \type{none}] , {\sc mark} ~ \avmbox{2} \type{marked}]}
	...
	[{\avmbox{4} [{\sc head} ~ \avmbox{1} , {\sc comps} ~ $<$(PP[\type{by}]$_{i}$)$>$ , {\sc mark} ~ \avmbox{5} \type{unmarked}]}
		[{[{\sc head} ~ \avmbox{1} , {\sc comps} ~ $<$ (PP[\type{by}]$_{i}$) , \avmbox{3}$>$ , {\sc mark} ~ \avmbox{5}]} [description]]
		[{\avmbox{3} [{\sc head} ~ \type{prep} , {\sc comps} ~ $<$ ~ $>$]} [of the Hungarian NP, roof]]]]
	\end{forest}
...
\begin{figure}
	...
	\begin{forest}
sm edges
[{[{\sc head} ~ \avmbox{1} \type{det} , {\sc comps} ~ $<$ ~ $>$]}
	[{[{\sc head} ~ \avmbox{1} , {\sc comps} ~ $<$\avmbox{4} NP$>$]} [that]]
	[{\avmbox{4} [{\sc head} ~ \avmbox{2} \type{noun} , {\sc comps} ~ $<$ ~ $>$]}
		[{[{\sc head} ~ \avmbox{2} , {\sc comps} ~ $<$\avmbox{3} PP$>$]} [sister]]
		[\avmbox{3} [of Leslie, roof]]]]
	\end{forest}
...
\begin{figure}
	...
	\begin{forest}
sm edges
[{[{\sc head} ~ \avmbox{1} \type{noun} , {\sc comps} ~ $<$ ~ $>$]}
	[N [het]]
	[{[{\sc head} ~ \avmbox{1} , {\sc comps} ~ $<$ ~ $>$]}
		[{[{\sc head} ~ \avmbox{1} , {\sc comps} ~ $<$\avmbox{2} PP$_{j}$$>$]}
			[{[{\sc head} ~ \avmbox{4} \type{verb} , {\sc comps} ~ $<$NP$_{j}$$>$]}
			[\avmbox{3} [op diepte, roof]]
			[{[{\sc head} ~ \avmbox{4} , {\sc comps} ~ $<$NP$_{j}$ , \avmbox{3} PP$_{k}$$>$]} [houden]]]]
