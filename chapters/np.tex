...
[{[\textsc{head} \avmbox{1} \type{noun}, \textsc{spr} \eliste, \textsc{comps} \eliste]}
		...
		[{[\textsc{head} \avmbox{1}, \textsc{spr} \liste{\avmbox{2}}, \textsc{comps} \eliste]} 
			[{[\textsc{head} \avmbox{1}, \textsc{spr} \liste{\avmbox{2}}, \textsc{comps} \liste{\avmbox{3}}]} [sister]]
			[\avmbox{3} PP [of Leslie,roof]]]]	
\end{forest}
...
[{[\textsc{head} \avmbox{1} \type{noun}, {\sc spr} \eliste]}
	...
	[{[\textsc{head} \avmbox{1}, \textsc{spr} \liste{\avmbox{2}}]}
		...
		[{\avmbox{3} [\textsc{head} \avmbox{1}, \textsc{spr} \liste{\avmbox{2}}]}, before drawing tree={x+=2em} [sister of Leslie, roof, before drawing tree={x+=2em}]]]]
\end{forest}
...
[{[\textsc{head} \avmbox{1} \type{det}, \textsc{comps} \eliste]}
	...
	[{\avmbox{4} [\textsc{head} \avmbox{2} \type{noun}, \textsc{comps} \eliste]}
		[{[\textsc{head} \avmbox{2}, \textsc{comps} \liste{\avmbox{3}}]} [sister]]
		[\avmbox{3} PP [of Leslie, roof]]]]
\end{forest}
...
\begin{forest}
sm edges
[{[\textsc{major} \avmbox{1}, \textsc{minor} \avmbox{2}]}
		[{[\textsc{major} \avmbox{1}, \textsc{minor} \avmbox{2} \textsc{fcompl} +]} [that]]
		[{[\textsc{major} \avmbox{1} [--V, +N[\type{sing}]], \textsc{minor$|$fcompl} --]} [sister of Leslie, roof]]]
\end{forest}}
...
In head-argument phrases, the head daughter selects its nonhead sister(s) by means of 
...
\z
\ea\label{mark2} 
\type{head-nonargument-phrase} ~ \impl ~
\begin{avm}
[synsem|loc|category|marking ~ @1 \type{marking}   \\
...
in which the nonhead daughter selects its head sister. This selection is modeled 
...
sm edges
[{[\textsc{head} \avmbox{1} \type{noun}, \textsc{mark} \avmbox{2} \type{marked}]}
	[{[\textsc{head$|$sel} \avmbox{4}, \textsc{mark} \avmbox{2}]} [beaucoup;much]]
	[{\avmbox{4} [\textsc{head} \avmbox{1}, \textsc{mark} \avmbox{5} \type{de}]}
		[{[\textsc{head$|$sel} \avmbox{3}, \textsc{mark} \avmbox{5}]} [de;of]]
		[{\avmbox{3} [\textsc{head} \avmbox{1}, \textsc{mark} \type{bare}]} [farine;flour]]]]
\end{forest}}
