...
spelled out in (\ref{min}) \citep[312]{Netter94}.\todostefan{The MINOR features should be shared
...
prepositions must, hence, be positively specified for \textsc{fcompl}.\todostefan{this is not a problem} 
...
An illustration of the functor treatment is given in Figure~\ref{markyy}.\todostefan{add a more
...
Its defining properties are spelled out in (\ref{acccx}) \citep[16]{Malouf00}.\todostefan{head-dtr
...
the English possessive as a genitive, differently from \citet{SagWasow03}.}\todostefan{head-dtr
  structure sharing inherited? hence redundant?}  
...
\type{intersective-modification}, as defined in (\ref{mononom}).\todostefan{since intersective-mod
...
They are spelled out in (\ref{bigmess2}).\todostefan{If this is the definition, the structure
...
shares with the NP as a whole, as spelled out in Figure~\ref{beau}.\todostefan{add glosses to de in figure} 
...
the surface-oriented monostratal character of HPSG than the DP treatment.\todostefan{Add: As for now
