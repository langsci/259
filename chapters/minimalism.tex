...
the mid-1980s to HPSG (\citealt{ps}; see \crossrefchapteralt{evolution} for more on the origins of HPSG).\footnote{
...
We look first at binary branching.\footnote{
  ...
  \citep{Partee87a-u}. For respective HPSG analyses see \citew[\page 91--92]{Flickinger2008a},
...
are problematic for \isi{SOV} languages like \ili{German}. To see why, consider the examples in
