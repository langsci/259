...
making use of different mechanisms is discussed in \citet[Chapter~20]{MuellerGT-Eng3}.%
...
%% the HPSG community (see \crossrefchaptert{cxg} and \citet[Section~10.6.2]{MuellerGT-Eng2} for
...
and this view seems fairly standard within Minimalism; see also the discussion in \citet[Section~3.6.2]{MuellerGT-Eng1}. \citet[\page 28]{CL95a-u}
...
were built on a shaky empirical basis. See \citet{Mueller2007c} and \citet{MM2009a} for the
discussion of introspection vs.\ corpus data and \citet{HS2010a-u} and \citet{GF2013a-u} for the discussion of introspection
...
\citet{CHH82a-u}. \citet[\page 437]{Williams89a-u} and \citet[\page 221]{Falk2010a-u} have examples
...
phenomena may turn out upon careful investigation to be significantly different.\footnote{%
  ...
  be quite similar. For further discussion of HPSG and comparative syntax, see \citet{Borsley2018a}.%
} 
...
of acceptability, see \citet[\page 29]{PS2001a}.
}
...
%% mentioned here see \citet[\page 114--116]{MuellerGT-Eng3}.
...
%% }%\todostefan{\citet[\page 142]{Chomsky2008a} contrasts c-command with Agree} 
...
\citet[\page 333]{BG78a}, which is also cited in other mainstream generative work, such as
\citet{GR81}. (\mex{0}b) is from \citet[\page 1068]{HPP2002a-u}, a descriptive grammar of English.
...
\footnotetext{%
        ...
        Studien zur deutschen Grammatik, number 33. T\"ubingen: Gunter Narr Verlag. 1988, p.\,16, quoted from \citet[\page 61]{Mueller99b}.
      }
...
\footnotetext{%
        Wiglaf Droste, taz, 01.08.97, p.\,16, quoted from \citet[\page 61]{Mueller99b}.
      }\\
...
\citet[Section~4.6.2]{MuellerGT-Eng1} for a more detailed discussion of labelling.
...
For typical Generative Semantics proposals of this kind, see \citet{McCawley68b-u} and
\citet{Postal70a-u}. Like Minimalism, Generative Semantics was characterized by extremely complex
syntactic structures and for similar reasons. See \citet[Chapter~4]{Newmeyer86a-u} for discussion.%
}
...
See \citet[53--56]{CJ2005a} for further discussion. For more recent Minimalist work assuming lexical decomposition, see, \eg \citet{Harley2012a-u}.%
}
...
\citet{EV96a}, \citet{deKuthy2000a}, and also \crossrefchaptert{information-structure}. On determination of clause types\is{clause type}, see
\citet{GSag2000a-u} and \citet{MuellerSatztypen}. For general discussion of the representation of
information usually assigned to different linguistic ``modules''\is{modularity} and on ``interfaces''\is{interface}
between them in theories like LFG and HPSG, see \citet{Kuhn2007a}.
...
For actual HPSG analyses dealing with adverb order, see \citet{KM2005a}.
...
We look first at binary branching.\footnote{
  ...
  \citep{Partee87a-u}. For respective HPSG analyses see \citet[\page 91--92]{Flickinger2008a} and
  \citet{MuellerPredication}. The lack of unary branching structures in Minimalism is
  ...
  example \citet[\page 370]{Ramchand2005a}. So, while the effects of unary projections can be
  modelled, the resulting structures are more complex. For a general discussion of empty elements,
  unary projections, and lexical rules\is{lexical rule}, see \citet[Sections~19.2 and~19.5]{MuellerGT-Eng1}.
% 
...
ternary branching structure in Figure~\ref{fig:gave-lee-book}, which is suggested in \citet[\page 36]{ps2} and much other work.
\ea
...
frontings that makes an analysis which is the HPSG analogue of head-movement unavoidable. See \citet{MuellerGS} for a
...
\footnotetext{
  taz, 05.09.2018, p.\,20, quoted from \citet[\page \pageref{ex-schwarzen-stein}]{chapters/cxg}.
}
...
impersonal passive\is{passive!impersonal} such as (\mex{1}):\footnote{%
	See \citet[\page 11--12]{Koster86a} for a parallel analysis for Dutch\il{Dutch} as well as 
	\citet{Lohnstein2014a} for a movement"=based account of the passive that also involves an
...
above can be avoided. See \citet[Section~3.4, Chapter~20]{MuellerGT-Eng1} for further discussion.
...
Merge.\footnote{%
  ...
  criticisms of this analysis, see \citet{Borsley2015a}.
...
\citet[Chapters~4 and~5]{CP2020a-u}.
...
\citet{SW2011a} and \citet[\page 525]{MuellerGT-Eng3}.%
...
For further discussion of how HPSG and Minimalism compare with respect to processing see \citet[Chapters~4 and~5]{CP2020a-u}.
...
%%   87--88, 177--178]{Lohnstein93a-u}; \citealp[\page 38]{FC94a}). See also \citet[\page
...
\end{quotation}
%
Much the same view is expressed in \citet[\page 164--168]{Hornstein2009a-u}.
...
including L2 acquisition, see \citet[Chapter~7]{CP2020a-u}.
...
\citet[\page 165]{Hornstein2009a-u} and \citet[\page 140]{Starke2014a-u} on heads, features, and restrictiveness. 
