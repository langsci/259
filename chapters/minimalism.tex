...
this allows them to sidestep the question of whether it is really justified. It also allows them to avoid
...
\caption{An analysis of local reordering as movement to Spec TP and a ``base-generation'' analysis
