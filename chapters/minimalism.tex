...
process that is triggered by agreement. It is claimed that this movement exists both in \ili{Hungarian} and in English but
...
%% \inlinetodostefan{
%%  wonder if we should say more about this. The assumption that V moves to T in \ili{French} but English I
%%  supposed to explain the fact that \ili{French} has V + pas while English not + V.
%% }
...
applies to words only and claims that \ili{German} differs from English in not allowing adjective noun
...
like English and \ili{Icelandic}, this element is realized before the verb: there is a valence feature for
