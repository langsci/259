...
\z
The \compsl is a list of \type{synsem} objects. It is converted into a lists of signs by the
...
(\ref{GSexemple57added-a}) is given as (\ref{GSexemple62added}):\footnote{%
