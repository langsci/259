...
\parencites{MuellerCopula}[39]{muller2018clause}. It is called \type{head-cluster-phrase},
...
(\ref{GSexemple26})).\footnote{Following \citet[\page 23]{HN94a} and \citet[\page 177]{dKM2001a}, but contrary to
  \textcites[\page 23]{Mueller2005c}{muller2018clause}, we mention the lightness of the mother and
...
\noindent
In the case studied by \citeauthor{MuellerPersian}, \emph{b\=az-konande}, the participle corresponding to the light verb construction exists, although the simplex participle does not (\ref{GSexemple70bis}).
