%% -*- coding:utf-8 -*-
\author{%
	Danièle Godard\affiliation{Université de Paris, Centre national de la recherche
    scientifique (CNRS)}%
...
The reader will have noticed that the four instances of \emph{zadan} discussed above have a lot in
