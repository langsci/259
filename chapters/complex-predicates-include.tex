...
\begin{exe}
        \ex[]{\emph{head-cluster-phrase}  (Spanish) \impl \\
		\avmtmp{
...
\begin{exe}
    \ex[]{\label{GSexemple71}%\scalebox{.95}{
		\avmtmp{
			[\type*{lexeme}
			phon & \1 \+ \2 \\ 
...
\begin{exe}
    \ex[]{\label{GSexemple73}%\scalebox{.8}{
	  \avmtmp{
	  	[\type*{lexeme}
		\phon \1 \+ \2 \+ < ande > \\ 
