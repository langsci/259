...
Many of the constraints discussed here were tried to capture with one general constraint called
Subjacency (Chomsky \citeyear[\page 271]{Chomsky73a}; \citeyear[\page 40]{Chomsky86b};
\citealp{Baltin81a,Baltin2006a}). The claim was that movement cannot cross so-called bounding nodes
and what exactly counts as bounding node was assumed to be a language-specific parameter in a
universal principle. While this begs the question since it requires innate knowledge involving part
of speech information \parencites[Section~13.1.5.1]{MuellerGT-Eng4}[\page 539--540]{Newmeyer2004a}, the claims are empirically wrong as well, as
\citet{Mueller2004d}, \citet{Mueller2007c}, \citet{MM2009a} and \citet{SS2013b-u} showed with corpus examples for
German and English.\footnote{
