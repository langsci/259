...
\is{given information|)} \is{new information|)}
%
In case \isi{prosodic information} is utilised for signalling information structure, a grammar has to account for the fact that prosodic constituency is not isomorphic to syntactic constituency, that is, prosodic structures cannot be built up in parallel to syntactic trees. 
%
