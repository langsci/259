...
The \textsc{content} \isfeat{content} value is of type \textit{ppro} (\textit{personal-pronoun}), which is related to the NP type ($+$p,$-$a) from \emph{Government and Binding} theory \citep{Chomsky81a} and interacts with HPSG's binding theory (see \crossrefchaptert{binding}; see also \crossrefchaptert{agreement}).
%
