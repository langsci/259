...
%
Within HPSG, the approach to \emph{prosodic constituency}\is{constituency!prosodic} of \citet{Klein:2000} employs \emph{metrical trees}\is{metrical tree} independent from syntactic trees, but grammatic composition remains syntax-driven.
%
...
%
The analysis of proper names\is{proper name} is pursued in a similar manner, amounting to the requirement that for a successful use of a proper name, the interlocutors have to know that the intended referent of this name actually bears the name in question.
%
\ea  \label{ex:dog}
	\oneline{
\avm{
