...
\begin{quote}
Language and writing are two distinct systems of signs; the second exists for the sole purpose of representing the first. The linguistic object is not both the written and the spoken forms of words; the spoken forms alone constitute the object.  \citep[\page 23\psq]{Saussure2011-EN} 
\end{quote}
...
%
Information structure realised by prosodic stress is also part of the speech-gesture interfaces within multimodal extensions of HPSG (cf.\ \crossrefchapteralt[Section~\ref{sec:iconic-gestures}]{gesture}.
\is{information structure|(}\is{focus|)}\is{information packaging|)}
...
\ea
\lueckingbox{}{\textbf{DGB dynamics}}{\textbf{Utterance{\slash}Conversational rules}}
