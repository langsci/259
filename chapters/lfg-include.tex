...
{
\makebox[4em][l]{\textit{this}\/: Det}\qquad\feqs{(\up \LFGfeat{prox}) $=$ $+$\\
...
{
\makebox[4em][l]{\textit{lion}\/: N}\qquad\feqs{(\up \LFGfeat{pred}) $=$ `lion'\\
(\up \LFGfeat{num}) $=$ \textsc{sg}}}
...
{\label{indent}
  \begin{tabular}[t]{@{}l@{}}
\makebox[4em][l]{\textit{roar}\/: V}\qquad\feqs{(\up \LFGfeat{pred}) $=$ \predvall{roar$\leftangle
(\up \LFGfeat{subj})\rightangle$}}
\\
\makebox[4em][l]{-\textit{s}\/: \textit{infl}\/\pslabel{v}}\qquad\feqs{(\up \LFGfeat{tense}) = \LFGfeat{pres}\\
...
{\textit{about}\/: P}\qquad\feqs{(\up \LFGfeat{pred}) = `about$\leftangle
(\up \LFGfeat{obj})\rangle$'}    
\zl

%\eal \label{talk-about}
%{\textit{talk}\/: V}\qquad\feqs{(\up \LFGfeat{pred}) = `talk-about$\leftangle
...
\ex {\makebox[4em][l]{\textit{she}\/: {D}}\qquad\feqs{
    (\up \LFGfeat{pred}) $=$ \predvall{pro}\\     
    (\up \LFGfeat{case}) $=$ \LFGfeat{nom}\\
    (\up \LFGfeat{pers}) $=$ 3\\
    (\up \LFGfeat{num}) $=$ \LFGfeat{sg}\\ 
    (\up \LFGfeat{gend}) $=$ \LFGfeat{fem}} }
\ex {\makebox[4em][l]{\textit{her}\/: {D}}\qquad\feqs{
        (\up \LFGfeat{pred}) $=$ \predvall{pro}\\     
				(\up \LFGfeat{case}) $=$ \LFGfeat{acc}\\
                  (\up \LFGfeat{pers}) $=$ 3\\
                  (\up \LFGfeat{num}) $=$ \LFGfeat{sg} \\
                  (\up \LFGfeat{gend}) $=$ \LFGfeat{fem}}}
\ex {\makebox[4em][l]{\textit{you}\/: {D}}\qquad\feqs{
        (\up \LFGfeat{pred}) $=$ \predvall{pro}\\     
                  (\up \LFGfeat{pers}) $=$ 2}}
\ex {\makebox[4em][l]{-\textit{s}\/: \textit{infl}}\qquad\feqs{
				(\up \LFGfeat{tense}) = \LFGfeat{pres}\\
                  (\up \LFGfeat{subj}) $=$ \down\\
                  \qquad(\down\ \LFGfeat{pers}) $=$ 3\\
                  \qquad(\down\ \LFGfeat{num}) $=$ \LFGfeat{sg}\\
...
\ea
\label{constrain}
{\makebox[4em][l]{\textit{she}\/: {D}}\qquad\feqs{
    (\up \LFGfeat{pred}) $=$ \predvall{pro}\\
...
give.\textsc{inf}  books.\textsc{acc}  this.\textsc{dat.sg}  student.\textsc{dat.sg} \\ \hfill (\ili{Serbo-Croatian})
\glt `to give books to this student'}  
\ex[*] {  \gll {pokloniti}  knjige  [ovih  pet  studenata] \\
give.\textsc{inf}  books.\textsc{acc}  \spacebr{this.\textsc{gen.pl}}  five  student.\textsc{gen.pl} \\
...
admire.\textsc{1sg}  \textsc{refl}  Miki \\\hfill (\ili{Serbo-Croatian})
\glt `I admire (my) Miki.'}
\ex[ ] {\gll  Divim  se  mojoj  Miki. \\
admire.\textsc{1sg}  \textsc{refl}  my.\textsc{dat.sg}  Miki \\
\glt `I admire (my) Miki.'}
\ex[]{
...
\eal \label{lex-w} 
\ex 
{\makebox[8em][l]{\textit{kurdu-jarra-rlu}\/: N}\qquad\feqs{
(\up \LFGfeat{pred}) = `child'\\
(\up \LFGfeat{num}) = \LFGfeat{dual} \\
(\up \LFGfeat{case}) = \LFGfeat{erg} }}

\ex 
{\makebox[8em][l]{\textit{maliki}\/: N}\qquad\feqs{
    (\up \LFGfeat{pred}) = `dog' \\
    (\up \LFGfeat{num}) = \LFGfeat{sg} \\
    (\up \LFGfeat{case}) = \LFGfeat{abs}}}

\ex 
{\makebox[8em][l]{\textit{wita-jarra-rlu}\/: N}\qquad\feqs{
    (\up \LFGfeat{adj}\ \ensuremath{\in} \LFGfeat{pred}) = `small' \\
    (\up \LFGfeat{num}) = \LFGfeat{dual} \\
    (\up \LFGfeat{case}) = \LFGfeat{erg} }}

\ex 
{\makebox[8em][l]{\textit{wajilipi-nyi}\/: V}\qquad\feqs{
...
\ex 
{\makebox[8em][l]{\textit{ka-pala}\/: Aux}\qquad\feqs{
