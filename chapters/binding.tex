...
I also think you might have sone more examples of exempt anaphors since this is quite important in
Pollard and Sag.\\
Stefan: I added the exempt anaphors to the intro, which actually corrected some of the statements
made there. I would not like to discuss more examples here, since the paper is long already.}
