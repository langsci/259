...
vizinho do Max$_{k}$]$_{l}$ gosta dele pr\'{o}prio$_{*x/*i/j/*k/l}$]. (\ili{Portuguese})\\ ...{\em
X}$_{x}$...the friend of\_the Lee thinks that the neighbour of\_the Max likes of\_him self\\
\trans '...{\em X}$_{x}$...[Lee$_{i}$'s friend]$_{j}$ thinks [[Max$_{k}$'s neighbour]$_{l}$
likes \linebreak
...
\sn
{...{\em X}$_{x}$...[Lee$_{i}$'s friend]$_{j}$ thinks [[Max$_{k}$'s neighbour]$_{l}$
likes \linebreak
 him$_{x/i/j/k/*l}$].}
\end{exe}
...
\sn {...{\em X}$_{x}$...[Lee$_{i}$'s friend]$_{j}$ thinks [[Max$_{k}$'s neighbour]$_{l}$
...
\is{o-binding}
{\em O-binding} is such that $x$ o-binds $y$ iff $x$ o-commands $y$ 
and $x$ and $y$ are coindexed ({\em o-freeness} is non o-binding).

{\em Coindexation} is meant to represent an anaphoric link between the expressions 
with the same index ('...{\em X}$_{x}$...' represents a generic, extra-sentential
...
\is{o-command}
\is{obliqueness}
{\bf Command} {\em O-command} is a partial order defined on the basis of
...
upwards o-commander {\em Pedro's director}, and once it is thus o-commanded, in accordance do Principle A, it cannot take other nominal in the sentence,
...
\is{reference marker}
For an anaphoric nominal {\em n}, the relevant input context may be represented
...
obliqueness; {\bf Z} contains  the markers of the (local and non local) \mbox{o-command} order where {\it n}
...
list \linebreak {\bf C}={\bf U}$\backslash$({\bf Z'}$\cup$[r-mark$_{n}$]),
...
Assume also that the sets {\bf A}, {\bf Z} and {\bf U}, of length {\it n} at worst, 
...
leaf node of the tree to obtain one of the sets {\bf A'}, {\bf Z'}, {\bf B} or {\bf C} are:
...
feature {\sc cont(ent)}. This value, of sort {\em udrs}, has a structure permiting that the mapping 
...
correspond to the lists {\bf A}, {\bf Z} and {\bf U} above. Subfeature {\sc list-lu}
...
{\em principleA}(\raisebox{.25ex}{\avmbox{3}},\raisebox{.25ex}{\avmbox{2}})
...
\begin{avm}
\hfill
\sort{{\it synsem}}{[loc|cont|arg-s <$\cdots$,
...
\begin{avm}
\hfill
\sort{{\it synsem}}{[loc|cont|arg-s <$\cdots$, [loc|cont|anaph|r-mark & @k],\\
																																								$\cdots$,
...
clause, a pronoun ({\em he}) and a short-distance reflexive ({\em himself}), and a quantificational
...
from which the list 
%$\langle\raisebox{-0.7ex}{\em \begin{avm}\@{54}, \@{247}, \@{24}, \@{392}\end{avm}}\rangle$
...
%$\langle\raisebox{-0.7ex}{\em \begin{avm}\@{415}, \@{54}, \@{247}, \@{24}, \@{392}\end{avm}}\rangle$
...
{\sc var} value 
%\raisebox{-0.7ex}{\em \begin{avm}\@{54}\end{avm}}
...
{\sc r-mark} value
%\raisebox{-0.7ex}{\em \begin{avm}\@{247}\end{avm}}
...
%\raisebox{-0.7ex}{\em \begin{avm}\@{1}\end{avm}} 
...
%\raisebox{-0.7ex}{\em \begin{avm}\@{24}\end{avm}}
...
%$\langle\raisebox{-0.7ex}{\em \begin{avm}\@{415}, \@{247}, \@{54},\@{392}\end{avm}}\rangle$, 
...
Also the marker 
%\raisebox{-0.7ex}{\em \begin{avm}\@{392}\end{avm}}
...
antecedent in this example of {\em him} is blocked.
...
to Principle C. 
But {\em the patient} --- because is o-commanded by {\em the boy} --- cannot have it as antecedent, 
...
such as {\em this sailor} or {\em the captain who knows this sailor}, can be 
...
{\textbf{R-Principle E:}} An e-marker antecedent cannot o-bind its anaphor (in \mbox{e-type} anaphora).
