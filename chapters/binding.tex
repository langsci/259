...
dominating A. As of 2020-02-25 the English and \ili{German} Wikipedia pages for c-command have two
...
\citet[Section~20.2]{Mueller99a} pointed out, it makes wrong predictions as far as \ili{German} and English are
...
make wrong predictions for \ili{German} anyway and its merits for English short passives are unclear
...
\ili{Mandarin} \ili{Chinese}: \citet{ML2009a} argue that VPs are combined to form a new complex VP with a
...
grammars of \ili{German}. The problem also applies to English, although English does not have complex
...
% AMM2017 cite \citet{Bresnan2001a} with Malayalam, \ili{Korean}, \ili{Balinese}, \ili{Japanese}, and other languages ). 
...
So far we have discussed binding for English with some occasional reference to \ili{Mandarin} \ili{Chinese},
