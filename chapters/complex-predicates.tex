...
\begin{itemize}
	...
	\item Certain constructions in German and Dutch, called coherent constructions, headed by tense auxiliaries, certain raising and control verbs, certain verbs with predicative complements, as well as the copula and particle verbs \citep{hinrichs1989flipped, HN94a-ohne-crossref, Rentier94, Kiss94, kiss1995infinite, BvN98-ohne-crossref, HN98a, Kathol98b, kathol2000linear, Meurers2000, DM2002, dKM2001a,  Mueller2002b, muller2003solving, muller2018clause};
...
\begin{exe}
	...
	\begin{xlist}
		...
		\ex[*]{ 
		\gll [Le volvi\'o a pedir] [un aut\'ografo] y [a hacer] [proposiciones].\\
		To.him started.again to ask an autograph and to make propositions\\}\label{GSexemple24c}
	\end{xlist}
\end{exe}
...
In certain languages, a complex verb construction signals itself essentially by properties of word order. This is the case for instance in German \citep{hinrichs1989flipped, HN94a-ohne-crossref, Kiss94, kiss1995infinite, HN98a, Kathol98b, kathol2000linear, Meurers2000, DM2002, dKM2001a, Mueller2002b, muller2003solving, muller2013copula} and Dutch \citep{Rentier94, BvN98-ohne-crossref}, as well as Korean \citep{ Sells1991, CC1998, Yoo2003, Kim2016a-u}. We concentrate on coherent constructions in German, and on auxiliaries and control verbs in Korean.    
...
\begin{forest}
 [S 
    ...
    [V \ms{{\normalfont{\textit{fin}}}, comps \liste{ }, \normalfont{\textsc{light -}}} 
        [\ibox{2} NP [das Buch\\the book, base=bottom, tier=word, roof]]    
        [V \ms{{\normalfont{\textit{fin}}}, comps \liste{ \ibox{2} }, \normalfont{\textsc{light -}}} 
            [\ibox{1} NP [jeder\\everybody, base=bottom, tier=word]]
            [V \ms{{\normalfont{\textit{fin}}}, comps \liste{\ibox{1}, \ibox{2} }, \normalfont{\textsc{light +}}} [kennt\\knows, base=bottom, tier=word]]]]]
\end{forest}
    \caption{}
    \label{GSfigure10}
\end{figure}
...
Within a hierarchical organization of the lexicon (chapter ?????), the content of the simplex verb is higher and less specialized than that of the predicative noun. Thus, the content of the complex predicate can be simply that of the noun, if it unifies with it. This is reminiscent of the way \cite{wechsler1995} represents the import of a PP with a verb like \textit{talk}; the verb content itself is represented as an \textit{soa} with one participant, the talker; the verb can take a number of PP complements (headed by \textit{to, about…}), and its content is then unified with that of the PP. The result is a description of an \textit{soa} with more information than is present in the verb alone. Similarly, here, the content of \textit{lagad} is more specialized than that of \textit{zadan}; hence, it takes over if it is unified with it. The complement of the complex predicate may be an NP or a PP headed by \textit{be} (the preposition is optional). 
