...
\label{rsg}
\ex
\ex \type{subj-rsg-lx} \impl \avmtmp{ [ \argst  \1 \+ < [subj & \1 ] > ]} \label{rais-1}
\ex \type{obj-rsg-lx}  \impl \avmtmp{ [ \argst  < NP > \+ \1 \+ < [subj & \1 ] > ]} \label{rais2}
\zl
...
\ex
\label{subj-cont-lx}
\type{subj-cont-lx} \impl \avmtmp{ [ \argst  < NP$_{\tag{i}}$, \ldots, [subj & < [ind & \tag{i} ] > ] > ]}
\ex
\type{obj-cont-lx}  \impl \avmtmp{ [ \argst  < \0, \1 [ind & \tag{i}], [subj & < [ind & \tag{i} ] > ] > ]}
\zl
...
\inlinetodoobl{Anne: The VP should be typed \type{pro}. Stefan: I do not know how to do this.}
\ea
\emph{will} (pseudogapping):\\
\avmtmp{
[ arg-st < \1, VP[\subj < \1 >, comps \2 ] > \+ \2 ]
}
\z
