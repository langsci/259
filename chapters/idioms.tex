...
\footnote{We do not need to specify the \feat{rel} value for the noun \emph{beans}, as the \feat{listeme} and the \feat{rel} value are usually identical.}
...
construction, or \emph{\isi{Comparative Correlative Construction}}.  Borsley analyzes this construction by
