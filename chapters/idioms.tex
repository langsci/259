...
Following the heritage of GPSG\indexgpsg, we would assume that all regular aspects of linguistic expressions can be handled by mechanisms that follow the SLH, 
...
This is in sharp contrast to the basic motivation of Construction Grammar\indexcxg, which assumes that constructions can be of arbitrary depth and of an arbitrary degree of idiosyncrasy. 
