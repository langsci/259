...
Generative\is{Generative Grammar} Grammar,\footnote{%
  I follow \citet[\page 3]{CJ2005a} in using the term \emph{Mainstream Generative Grammar} (MGG) to
...
The general assumption about idioms in Mainstream Generative Grammar\is{Generative Grammar} is that they
