...
They take as their starting point the syntactic flexibility of semantically non"=decomposable idioms in English and, in particular, in \ili{German}.
...
To give just one example, while there are barely any restrictions on passive subjects in \ili{German}, there are strong discourse-structural constraints on passive subjects in English.
...
This has been documented for English\il{English} in \citet{Ho:15}, for Modern \ili{Hebrew}\il{Hebrew} in \citet{Almog:12}, and for Modern \ili{Greek} and \ili{German}\il{German} in \citet{Markantonatou:Sailer:16}. 
...
The majority of work on idioms in HPSG has been done on English and \ili{German}. 
...
Similarly, the above-mentioned data on possessive alternations only become prominent when languages beyond English are taken into account. Modern \ili{Greek}\il{Greek}, \ili{German}\il{German}, and many others
...
\kommentar{
The majority of work on idioms in HPSG has been done on English and \ili{German}, with a new line of research on Modern \ili{Hebrew}\il{Hebrew} \citep{Sheinfux:al:15,HMW2016a-u}. 
...
\kommentar{
\begin{itemize}
\item Work by Espinal on \ili{Spanish} and \ili{Catalan} in comparison to English
