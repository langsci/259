...
%
For instance, the unembedded gesture in (\ref{ex:slap-unembedded}) triggers the inference that the event being described actually happened in the manner in which it was gesticulated \citep[\page 303, ex. (9b.)]{Schlenker:2018}:
%
...
Embedding the slapping gesture under the \textit{none}-quantifier triggers, according to \citet[\page 303, ex. (11a.)]{Schlenker:2018}, the following inference:
%
