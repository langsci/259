...
Integrating a gesture's contribution to speech was initiated in computer science.
%
...
\subsection{Tools, annotation, corpora}
...
%
A part of SaGA is available from the \textit{Bavarian Archive for Speech Signals} (\url{https://www.phonetik.uni-muenchen.de/Bas/BasSaGAeng.html}).
