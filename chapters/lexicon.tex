...
{\tikzexternaldisable
  %%% There is a problem with \@1, probably having to do with catcode of
  %%% "@": The tree is remade (in an embedded process) at every compilation.
  %%% Let's disable externalization until we figure out how to fix this.
\begin{figure}
	\begin{forest}
...
{\tikzexternaldisable %%% same problem as above
