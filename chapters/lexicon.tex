...
Likewise, the \attrib{arg-st}  \is{\textsc{arg-st}} list, which we included in the categorial information of signs in (\ref{va-lx}) and (\ref{y-va-lx}), might be regarded as a feature confined to lexical signs (see, among others, \citealt{GSag2000a-u}), on the premise that lexical items alone specify combinatorial requirements (but see \citet{Przepiorkowski2001} for a contrary view, and see \crossrefchaptert{cxg} for other views questioning this assumption).
