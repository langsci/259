...
To the extent that these ``narrow conflation classes'', as Pinker (1989)\todostefan{reference missing} terms them, are founded on clear semantic criteria, we can readily state syntactic and semantic constraints on the appropriate types in the relevant type hierarchy.
