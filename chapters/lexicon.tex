...
The type hierarchy in (\ref{def-verb-hier}) provides an example (here, the nondefeasible information comes first, and the set of defeasible structures follows the slash.\is{irregular morphology}

% Lascarides \& Copestake figure 3 (p. 61) goes here
\begin{exe}
\ex\label{def-verb-hier}
