...
Stefan: Then it was Riehemann. I checked the Copestake papers and she had IN and OUT or avoided it altogether.} The difference between the two representations with only the attributes \feat{synsem} and \feat{phon} included for expository purposes is shown in (\ref{two-lex}).
