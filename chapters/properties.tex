...
\noindent
These exemplify the nominal extraposition construction \citep{ML96a}, the comparative correlative construction \citep{Abeille2006a,AB2008a-u,Borsley2011a-u}, and the \emph{X’s Way} construction \parencites{KF99a}[Section~7.4]{Sag2012a}\inlinetodoobl{\citet{KF99a} do not deal with the way-Construction.}. As we will see, HPSG is an approach which is able to accommodate broad linguistic generalizations and highly idiosyncratic facts and everything in between.\footnote{%
  Idioms have also been an important focus of research in HPSG. See e.g. \citew{RS2009a}, \citew{KM2019a}, and \crossrefchaptert{idioms}.}
%
