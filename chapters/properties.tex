...
%
\footnote{The constraint in (\ref{ex:prop11}) is plausible for \ili{English}, but it is too strong for some languages, especially for languages with complex predicates or partial VPs (see \crossrefchapteralp{complex-predicates}), and also for SOV languages if they are analysed in terms of binary branching (see \crossrefchapteralp{order}).}
%
...
\noindent
As far as we are aware, no one has proposed such an analysis for \ili{English} interrogatives, but essentially this analysis is proposed for \ili{German} interrogatives in \citet[81]{Kathol2000a}.%
%
