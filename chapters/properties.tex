...
%
\footnote{In most HPSG work, all constraints are equal. Hence, there is no possibility -- as there is in Optimality Theory -- of violating one if it is the only way to satisfy another more important one \citep{Malouf2003a}. However, see \citet{MK2000a} and \citet{OFTM2004a-u} for an HPSG parser with probabilities or weighted constraints.}
%
...
These exemplify the nominal extraposition construction \citep{ML96a}, the comparative correlative construction \citep{Abeille2006a,AB2008a-u,Borsley2011a-u}, and the \emph{X’s Way} construction \citep[Section~7.4]{Sag2012a}. As we will see, HPSG is an approach which is able to accommodate broad linguistic generalizations, highly idiosyncratic facts, and everything in between.\footnote{%
  Idioms have also been an important focus of research in HPSG. See e.g.\ \citet{RS2009a}, \citet{KM2019a}, and \crossrefchaptert{idioms}.}
%
...
English filler-gap constructions, and SBCG (Section~\ref{sec:prop7.2}) has generally employed a
...
Some recent work, e.g.\ \citet[\page 84]{Sag2012a}, has adopted a rather different view of at least
