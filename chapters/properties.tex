...
%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%
\section{The lexicon}\label{sec:prop4}\todosatz{The other section titles are capitalised tho}
...
%
\footnote{As discussed in Section~\ref{sec:prop7.1}, in some HPSG work, linear order is a property of so-called order domains, which essentially mediate constituent structure and phonology (see \crossrefchapteralp{chap-order}). }
%
...
%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%
\section{Concluding remarks}\label{sec:prop8}\todosatz{Other section titles were capitalised tho}
