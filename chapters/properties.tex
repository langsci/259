...
\noindent
Here, the two instances of the tag \ibox{1} indicate that the \type{synsem} object which is the
...
\itdopt{JP: I got confused for a while as you are talking of types and what is in the parentheses are feature names. Not sure what to do with this. Your choice.}
...
Other types of constraint\add{s} are relevant to the form of lexemes and words, e.g.\ constraints on \type{synsem} objects and on \textsc{phon} values. These are also relevant to the form of phrases.}
%
...
\itdobl{JP: I recommended dropping MRS style notation in (23). If you do, you need to drop this
  parenthesis too.}
\itdopt{Stefan: I know where it comes from: it is Mickey Mouse style MRS from SWB. I think it is ok
  as an approximation of MRS. I could reinstall the old AVMs \ldots}
...
\footnote{It has been argued that some adverbs and PPs are adjuncts and others are complements,
  ...
  \citealp{HA2014a-u}, and \crossrefchapteralp{negation}).
\itdblue{See also Paris \& Koenig (2003) for Spanish gerunds and suggestions as to tests/semantic differences between complement and adjunct gerunds in Spanish (I can send the BiBTeX entry and HPSG proceedings paper if needed, but it is a shameless plug that can safely be ignored)}
}
%
