...
\end{tabular}\end{avm}%\vspace{-2\baselineskip}
...
The focus projection potential of \textit{lieben} \citep{dKM2003a}:\\
  \begin{avm}
    ...
    arg-st  \XlstI{[loc|cat|head [\tp{noun}\\case & nom]\\fpp
...
\begin{avm}
  ...
  c-cont|icons & \< \normalfont{!} @2[\tp{non-focus}\\target @1]\ !\>\\
...
\begin{avm}
  ...
  c-cont|icons & \< \normalfont{!} [\tp{non-focus}\\target @2\\clause @1]\ !\>\\
  dtr \normalfont{\textit{lex-rule-infl-affixed}}]
\end{avm}
\z
\z
...
[\normalfont{\textit{sign}}\\
  embed & $-$]\end{avm} & \impl & \begin{avm} [phon @1]\ $\wedge$ \normalfont{\textit{decl-tune}}(@1)
  \end{avm}  \\
  \end{tabular}
