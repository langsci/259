...
questioning of Transformational Grammar (TG) culminated in a series of papers by Gerald Gazdar,
...
\isi{coordinate constructions} and \isi{unbounded dependency constructions} had long served as prime
...
in the notion of \isi{discontinuous constituency}, and also had an obvious affinity to
...
within the \isi{linearization grammar} avatar of HPSG developed by \citet{Reape90a},
...
Work on GPSG culminated in the \citeyear{GKPS85a} book \textit{Generalized Phrase Structure Grammar}
...
\citep{Flickinger:17}, among many others.  Commercial applications include \isi{e-commerce customer
  email response} (for YY Software), and \isi{grammar correction} in education (for \isi{Redbird
