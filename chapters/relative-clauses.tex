...
analysis which treats PRCs as \attrib{rel} marked clauses with both an internal and an
external subject (instances of \istype{head-subject-phrase}\type{head-subject-phrase} which have a non-empty
\attrib{subj} value), and which can consequently function as secondary
predicates.
\is{relative clause!predicative|)}
