...
realised as a \isi{relative pronoun}).\footnote{%
  ...
  determiner or a full NP. This is different from most approaches in Categorial Grammar, which assume that the relative word is the functor taking a clause
