...
sm edges
[%
\avm{S$_{inf}$\,[head & \1	\upshape ![\textsc{mod} \ibar{N}\ind{2}]! \\
   cont & \3 \\ % \[ \asort{fact} prop\|soa & \@4 \]\\
   slash & \{ \}\\
   rel & \{ \}\\
   subj & < \4 > ]}
...
\feat{slash} value containing a pronominal (\istype{prl}\type{prl}) element (that is, a CP
...
in the complements are amalgamated by the predicate resulting in the \SLASH value \{ \ibox{1} \} $\cup$
\ibox{4}. \added{The information about \SLASH elements coming from other arguments than the CP is carried
