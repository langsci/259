...
\lic{wh}-phrase.\footnote{We assume, for simplicity,
  ...
  which are alternative names for the feature that is used 
...
again, they are not common:\footnote{\pref{x:rc-236} is from \emph{The Guardian} `Notes
...
\pref{x:rc-29}:\footnote{On \citegen{Ginzburg:Sag:00} account, \pref{x:rc-29} is excluded
  ...
  [\feat{wh}~\setof{}], \feat{wh} corresponding to what we are here calling \feat{que} (the
