...
\begin{exe}
  ...
  \ex\label{x:rc-36}~\idx{1} : \ensuremath{\{person(\idx{1})\}}
\end{exe}
\begin{exe}
  \ex\label{x:rc-37}
  \begin{avm}
 ...
 \end{exe}
\begin{exe}
     \ex\label{x:rc-38}~\idx{1} : \ensuremath{\{person(\idx{1}),
        speak\_to(Kim,\idx{1})\}}
\end{exe}
...
\cite{Reape94a}, and \crossrefchaptert{order}). The relevant construction
...
\feat{extra}-style apparatus (e.g.\ \cite{Mueller2004b} and \cite{Crysmann2013a}), but in
