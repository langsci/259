...
variation (cf.\ for example, \citealt{Webelhuth92a-u}), but even in English the data are
...
suggest that Ss are not allowed in English. This much is relatively
...
are not allowed in English (cf. \pref{x:rc-291} with a preposed PP):
\begin{exe}\ex\begin{xlist}
