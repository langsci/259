...
realised as a \isi{relative pronoun}).\footnote{%
  ...
  combination. See \citet[Chapter~8.6]{MuellerGT-Eng1} for discussion and \crossrefchapterw{cg} for
...
seem fully acceptable.\footnote{Notice also that an analogue of \pref{x:rc-27} is
  ...
  for discussion and HPSG analyses of the phenomena in German. Some discussion of
  pied-piping in French can be found in \cite{Godard92} and \cite{SG94}.}
\begin{exe}\ex\begin{xlist}
...
\subsection{The lexical approach of \citet{ps2}}
