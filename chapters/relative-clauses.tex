...
\begin{exe}\ex\begin{xlist}
  \ex\label{x:rc-5}
\avmtmp{[synsem|loc|cat|head|mod &  [ loc|cat|head & noun ] ]}
  \ex\label{x:rc-6}
\avmtmp{[synsem|loc|cat|head|mod & [ loc|cat|head & verb ] ]}
 \ex\label{x:rc-7}
\avmtmp{[synsem|loc|cat|head|mod & none]}
\end{xlist}
...
\avmtmp{
  ...
  \ex\label{x:rc-18} \avmtmp{\ibar{N}$_{\1}$ [rel & \{ \1 \} ]}
\end{xlist}
...
\avmtmp{
   ...
   \ex\label{x:rc-20}
\avmtmp{S [mod & \upshape \ibar{N}$_{\1}$ ]}
 \end{xlist}
...
\avmtmp{\emph{inf-hd-fill-ph} \impl
...
\avmtmp{\emph{inf-hd-fill-rel-cl} \impl
...
controversial, and an interesting construction in \ili{French}.\footnote{There are also cases which involve a \isi{relative pronoun} \emph{and} a
  ...
  \begin{exe}
    ...
    the coat \hspaceThis{(}which that I bought have\\\jambox*{(\ili{Bavarian} \ili{German})}
...
\avmtmp{\emph{hd-relative-mod-phrase} \impl
	[head & noun \\
	slash &  \{ \} \\
...
\begin{figure}
	...
	[\ibar{N}$_{\ibox{1}}$ , baseline
		...
		[RP 
            ...
            [\avmtmp{\6 S: \3 [slash & \{NP$_{\ibox{1}}$\} ]}
            	[Kim bought,roof]
            ]
		]
   ]
...
\avmtmp{\emph{non-wh-rel-cl} \impl
	[ %\asort{rel-cl} 
