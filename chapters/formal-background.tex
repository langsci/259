...
structures.\footnote{\cite[294]{Pollard99a} still uses the term \emph{feature
  ...
  Section~\ref{sec-alt-gr-meaning}\inlinetodoobl{Stefan: Check reference. This was hardcoded, I
    changed to latex ref.} below.} \citet{King99a-u} suggests \emph{exhaustive models},
