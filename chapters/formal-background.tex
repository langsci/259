...
lists (\texttt{append}\is{append}, \texttt{shuffle}\is{shuffle}) or sets (\texttt{union},
\texttt{intersection}). Lists\is{list} are usually encoded\label{page-list-encoding}
