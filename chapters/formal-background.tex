...
\begin{exe}
  ...
  $\left(\its\sim\mbox{\type{headed-phrase}}\right)\rightarrow$\\ % \wedge \its\feat{dtrs}\sim\mbox{\type{headed-struc}}
...
\footnote{In RSRL syntax, (\ref{ex-word-order}) can be written as\\
  ...
  $\left(\its\mbox{\feat{phon}}\approx x_3\wedge\its\mbox{\attrib{head-dtr phon}}\approx x_2\wedge\its\mbox{\attrib{non-hd-dtrs first phon}}\approx x_1\wedge\mbox{\texttt{append}}(x_1,x_2,x_3)\right)$
}
