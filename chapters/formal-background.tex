...
\emph{types} of feature structures (the term that
replaces the \emph{sorts} of 1994,
...
Word Principle \citep*[500]{MRR2018a-ed-2nd}.\marginpar{Can the book chapter be referenced directly?} LE$_{1}$ to LE$_{n}$
...
in the semantics chapter, \crossrefchapteralt[example (\ref{sign-cons})]{semantics}.}
...
\attrib{rest}, and sorts \type{list}, \type{elist} (for empty list) and
...
x\,\texttt{synsem-rel}(x)$ describes every object in $\Inte$\marginpar{restrictive rel cl!} all of
...
English is obviously too small to count as a good candidate for
