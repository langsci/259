...
implicational constraints similar to \rref{nonc:cp:germ1}–\rref{nonc:cp:germ2}.
The first constraint resolves the first structurally-cased element of the
...
the direct object or an adjunct.  The second constraint resolves the structural
...
governing verbs.  In particular, dependents of the subject are raised to the valence list
  for subjects \path{subj}, resulting in multiple valency subjects.
