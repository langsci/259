...
Figure~\ref{fig:case5}, by removing all those “pure” types which are only needed to represent some
...
\end{tikzpicture}
\caption{Add caption}\label{fig:case5}\label{fig:daniels21} 
\end{figure}
Hence, the above representation corresponds to seven types shown explicitly in Figure~\ref{fig:daniels20}
...
After early 2000s, such complex \ftype{case} hierarchies do not appear in HPSG work.  A~possible
...
examples \rref{ex:dis:pl}–\rref{ex:dis:ru} may be seen as special cases.\footnote{Another HPSG
  ...
  that of \citealt{yata:04}, according to which the – perhaps disjunctive or underspecified –
...
the linearisation approach of \citealt{Reape92a,Reape94a} and \citealt{Kathol95a}, and they have
been claimed to deal with some of the cases discussed in this section, e.g., by
\citealt{Crysmann2003c}, \citealt{BS2004a}, and \citealt{chav:06,chav:08}.  However, such
linearisation-based approaches to coordination have more recently come under attack: see
\citealt{levi:11} and \citealt{kub:lev:15} (as well as \citealt{yata:12,yata:16} and, especially,
...
namely, \rref{ex:syn:gfr}–\rref{ex:syn:epg}, demonstrated that feature neutrality is not limited to
