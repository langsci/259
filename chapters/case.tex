...
\pagebreak
\begin{examples}
\item\label{daniels18} \mbox{}\\\includegraphics[scale=.35]{daniels18.png}
\end{examples}
% \begin{verbatim}
%              scase
%             /     \
...
\begin{examples}
\item\label{daniels20} \mbox{}\\\includegraphics[scale=.35]{daniels20.png}
\end{examples}
...
Let us illustrate this approach with the two Polish examples~\aref{ex:syn:pc} and \rref{ex:dis:pl}, repeated below as \rref{ex:syn:pc:again}–\rref{ex:dis:pl:again}:
\begin{examples}
...
\begin{examples}
\item\label{daniels21} \mbox{}\\\includegraphics[scale=.35]{daniels21.png}
\end{examples}
...
\pagebreak
\begin{examples}
\item\label{daniels22} \mbox{}\\\includegraphics[scale=.35]{daniels22.png}
\end{examples}
