...
\eal \label{SP87}
\ex
If the semantic content (\ibox{1}) of the head daughter is of sort \type{circumstance} and the semantic content (\ibox{2}) of the complement daughter is of sort \type{quantifier}, the semantic content of the mother is \avm{[quant & \2 \\ scope & \1]}.\\
