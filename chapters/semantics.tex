...
{\avmoptions{center}\begin{avm}\[cont$|$prop & \@1\] $\rightarrow$ H\[cont & \@1\]\end{avm}}
\end{exe}
...
within the verb's \attrib{excont} (\avmbox{4b} $\triangleleft$ \avmbox{1}) and
