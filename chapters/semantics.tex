...
Because HPSG is a sign-based grammar, each constituent includes a phonological and semantic component as well as a syntactic level of representation (along with other possible levels, e.g.\ information structure; see \crossrefchapteralt{information-structure}). Compositionality has thus always been directly incorporated by principles that regulate the value of the mother's \feat{sem} attribute, given the \feat{sem} values of the daughters and their mode of syntactic combination (as manifested by their syntactic properties). Different approaches to semantics within HPSG  propose variants of a Semantics Principle that constrains this relation. The Semantics Principle of \citet[109]{PollardandSag1987} is stated in \ili{English} in (\ref{SP87}) (we assume for simplicity that there is a single complement daughter; \citeauthor{PollardandSag19987} define semantic composition recursively for cases of multiple complement daughters).
...
\end{forest}
\caption{\label{pot-contr-sem}\changed{\citeauthor{Kasper1997}'s analysis} of \word{potentially controversial}}
\end{figure}
...
\end{forest}
\caption{\label{every-dog-sem}The \changed{analysis} of \word{every dog}}
\end{figure}
...
\end{forest}
\caption{\label{every-dog-barks-sem}The \changed{analysis} of \word{every dog barks}}
\end{figure}
...
\end{forest}
\caption{\label{polish-nc-sem}The \changed{analysis} of Polish \word{nikt nie przyszed\l} `nobody came'}
