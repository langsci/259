...
\noindent
The problem with \citeauthor{PollardandSag1994}'s Semantics Principle\is{principle!Semantics|(}, when it comes to recursive modification, is clear: semantic selection follows an adjunct path, so to speak, so the most deeply embedded adjunct will have widest scope. 
