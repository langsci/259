...
\citet*{AMM2013a,Ackermanetal2017} propose a partial ordering\isfeat{arg-st} for certain so-called \emph{symmetrical object languages}.  In \ili{Moro} (Kordofanian), the
...
An alternative appears in \citet{KoenigandDavis2006}, who borrow from Minimal\indexmrs Recursion Semantics (see \crossrefchapteralt{semantics} for an introduction to MRS).
