...
concatenation of \feat{subj} and \feat{comps} respectively.  For example, the \subcat list for
...
These linking constraints also assume that the proto-role\is{proto-role} attributes \feat{actor}, \feat{undergoer}, and \feat{soa} are
...
\feat{act}, \feat{und}, and \feat{soa} can capture most of what needs to be stated about linking
...
\feat{act} and \feat{und} are identical, and ``unaccusative'' verbs (such as \word{fall} or
\word{vanish}), which lack an \feat{act} in their \feat{content}.  In the following sections, we
