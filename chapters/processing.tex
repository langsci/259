...
The local cooccurrence\itd{JP: for later editions: Maybe a word or two on what local means in this
  context may be useful for nonHPSGers} of these different types of information within a single
...
on to say that \isi{the lexical boost} argues for ``a representation that encodes a binding between
...
type).\itd{JP: Cite \citew{YKD2019a-u}?}
...
grammarians, with the former (e.g. \citeauthor{Chaves2012} \citeyear{Chaves2012} and\itd{JP: Cite
  Chaves \& Putnam? \url{https://global.oup.com/academic/product/unbounded-dependency-constructions-9780198784999}}
