...
(I will refer to these non-pronominal elements as \emph{\isi{conominals}}, following \citealt[\page 205]{haspelmath13}). The term that Haspelmath suggests -- and I will use -- for such argument indexes is pro-index. One language showing pro-index behavior with its argument indexes is \ili{Macushi}, as revealed from the examples in (\ref{macushi}): 
%
\begin{samepage}
\begin{exe}
...
\trans `I made it.'}
\itdobl{The papers translate this as ``He made it.''}
\ex[*]{\label{mac b}
...
\itdobl{Sources say ``I, I made it.''}
\end{xlist}
\end{exe}
\end{samepage}
