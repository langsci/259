...
\begin{exe}
  \ex \label{ex:mph} 
  \begin{avm}
    {\normalfont\textit{mph}} ~$\rightarrow$~ \[ph & list(phon)\\
      pc & pos-class\]
  \end{avm}
...
\begin{exe}
  \ex \label{ex:MudMS}
  \begin{avm}
        {\normalfont\textit{realisation-rule}}
    $~\rightarrow$~ \[mud & \@1 set(msp)\\
      ms & \@1 ~$\cup$ set(msp)\\
    mph & list(morph)\]
  \end{avm}
...
\begin{figure}[htb]
  \begin{center}
    ...
    \begin{avm}
           {\normalfont\textit{word}}
    $~\rightarrow$~ \[mph & \@{e$_1$} $\bigcirc\dots\bigcirc$ \@{e$_n$}\\
...
\begin{figure}[htb]
  ...
  \begin{subfigure}{\textwidth}
    \centering
      \begin{avm}
    {\normalfont\textit{word}}
    $~\rightarrow$~        \[ph & \@1 $\oplus \dots \oplus$ \@n\\
