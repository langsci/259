...
\citep{Riehemann98}. In inflection, change in morphosyntactic
...
of form and morphosyntactic properties between fully inflected words.
...
(IP), and 
Word"=and"=Paradigm (WP) --- fare with respect to these basic
...
As stated earlier, probably one of the first approach\-es to morphology
