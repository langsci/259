...
\begin{figure}[htb]
  ...
  \caption{Riehemann's type hierarchy of German \textit{-bar} derivation\inlinetodoobl{add pages}}
  \label{fig:Riehemann}
\end{figure}
...
\avmtmp{
	...
	morph-b &	<[\type*{trans-verb}
			  phon  \1 \\
			  synsem|loc  [cat|comps & < NP ![\type{acc}]!$_{\2}$ > \+ \3 \\
			               cont|nuc  & \4 [act & nom-obj \\
			                          und & \2] ] ] > \\
...
referential index not a complete semantic contribution of a noun phrase. This is shown in
(\mex{0}). In addition the sharing of the complete content of the two NPs is necessary, but this is
not given in (\mex{0}) to maintain readability.
}
