...
\avmtmp{
	...
	morph-b &	<[\type*{trans-verb}
				ph & \1 \\
				ss|l &	[cat|val|comps <NP ![\type{acc}]!$_{\2}$> \+ \3] \\
...
\begin{exe}
  \ex
  	\avmtmp{
	  	...
	  	morph-b  & <[ss|l|cat|val|comps & < NP![\type{acc}]!: \1 , \ldots> ]> ]
	  }
\end{exe}
...
morphology.\footnote{\citet{Blevins2003a} discusses the interaction
  ...
  \citet{ASU99a-u} for an account along these lines.  \citet[\page
  925--927]{MuellerUnifying} and \citet[Section~8.1]{MWArgSt} take a
  ...
  % apply to the output of another, or, as in the case of Turkish
  % causatives a rule may even apply more than
  % once. See also \citet[Section~7.5.2.2]{MuellerLehrbuch1} for  extensive
...
% \footnote{%
  ...
  % \citet[Section~7.5.2.2]{MuellerLehrbuch1}. See also \citet[\page
...
Compared to layered structure, the pivot feature approach just
