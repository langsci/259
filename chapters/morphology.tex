...
\abstract{
   \mbox{~}
% * <berthold.crysmann@gmail.com> 2018-01-16T16:46:49.084Z:
% 
...
introduce both modality and a  passivisation effect, there is a a
...
more general supertypes from individual subclasses may inherit. 
...
A notable exception to the function approach is the work
...
\begin{figure}[htb]
  ...
  \begin{tree}
    \br{\textit{verb-infl}}{
      \br{\avmbox{2ND-SLOT}}{
        \br{\rnode{1sg}{1sg}}{\lf{\rnode{1sg-pos}{1sg-pos}}}
        \lf{\textit{3pl}}
      }
      \br{\avmbox{1ST-SLOT}}{
        \psset{treesep=5em}
        \br{\textit{neg}}{\lf{\rnode{1sg-neg}{1sg-neg}}
        \lf{\textit{¬1sg-neg}}}
        \lf{\textit{pos}}
      }
      \br{\avmbox{3RD-SLOT}}{
...
\begin{figure}[htb]
  \begin{center}
    ...
    \begin{avm}
      % \[mph & \@{e_1} $\bigcirc\dots\bigcirc$ \@{e_n}\\
      %   rr & \{ \[mph & \@{e_1}\\mud & \@{m_1}\\ms & \@0\] ,\ldots\ ,
      %   \[mph & \@{e_n}\\mud & \@{m_n}\\ ms & \@0\] \}\\
      %   ms & \@{m_1} $\uplus\dots\uplus$ \@{m_n}
      %  \]
    \end{avm}
      \end{center}
...
\begin{figure}
  ...
  \begin{tree}
    \footnotesize
    \avmhskip{.5em}
    \psset{levelsep=8em,treesep=9em}
    \br{
      \begin{avm}
        \[mud & \{\[tma & ppp\]\}\\
          mph & \< ..., \[pc & 1\] \>\]
      ...
      \avmoptions{bottom}
      \psset{levelsep=5em,treesep=9em}
      \br{\avmbox{PREF}}{
        \lf{
          \rnode{pl}{\begin{avm}
              \[mph & \< \[ph & ge\\pc & -1\], \[ ~ \]\>\]
      ...
      \psset{levelsep=5em,treesep=10em}
      \br{\avmbox{SUFF}}{
        \lf{
          \rnode{abs}{\begin{avm}
              \[mph & \<..., \[ph & t\]\>\]
...
Figure \ref{fig:Horizontal} shows how Online Type Construction provide
...
\begin{sidewaysfigure}[htbp]
  \centering
  \begin{center}
    \hspace*{1em} {\scalebox{.8}{
      \begin{tree}
        \psset{levelsep=6ex,treesep=14em,linewidth=0pt,nodesep=0pt}
        \br{\textit{\raisebox{2pt}{\mbox{realisation-rule}}}} {
          \psset{treesep=8em,levelsep=26ex}
          \br{\rnode{M}{\avmbox{MORPHOTACTICS}}} { \lf{\rnode{V}{
                \begin{avm}
                  \[
                  mud & \{\normalfont\textit{agr} \}\\
                  ms & \{ \[\asort{pid}
          ...
          \psset{levelsep=6ex,treesep=7em,linewidth=0pt,nodesep=0pt}
          \br{\avmbox{EXPONENCE}}{
            \psset{levelsep=9em,treesep=8em,linewidth=0pt,nodesep=0pt}
            \br{\rnode{Q}{\avmbox{QUAL}}}{\lf{
                \begin{avm}
      ...
      \psset{angleA=-90,angleB=90,arm=0pt,linewidth=0pt}
...
\begin{figure}[htb]
  ...
  \scalebox{.73}{\begin{tree}
    \avmoptions{top}
    \psset{treesep=-5.5ex,levelsep=11ex}
    \br{
      \begin{avm}
        \[mud & \@1\\
        ms & \@1 ~$\cup$ set\]
    ...
    {
      \psset{treesep=24ex,levelsep=10ex}
      \br{
        \begin{avm}
      ...
      \psset{levelsep=30ex,treesep=25ex}
      \br{
        \begin{avm}
          \[mud & \{ \normalfont\textit{agr} \} \]
        \end{avm}
      ...
      {       
        \psset{levelsep=12ex,treesep=24ex}
        \br{ 
          \begin{avm}
            \[mph & \{ \[pc & $2$\] \} \]
          \end{avm}
...
\begin{figure}[htb]
  ...
  \scalebox{.75}{\begin{tree}
      \psset{levelsep=16ex,treesep=12em,linewidth=.8pt}
      \br{  \begin{avm}
        ...
        \psset{treesep=10em,levelsep=27ex}
        \br{\avmbox{MORPHOTACTICS}}{
          \lf{
        ...
        \psset{treesep=13em,levelsep=20ex}
        \br{\avmbox{EXPONENCE}}{
          \lf{
...
% } 
  ...
  \caption{Swahili relative markers}
  \label{fig:SwahiliRel}
\end{figure}
...
\begin{center}
  \begin{tree}
    \avmhskip{.5em}
\small\avmoptions{top}
      \psset{levelsep=6ex,treesep=11em,linewidth=.8pt}
\br{\textit{realisation-rule}}{
%\psset{linecolor=blue}
	\br{\avmbox{SHAPE}}{
		\lf{\rnode{a}{\begin{avm}
\[ mph & \{\[ph &  <ni>\]\}\\
   mud & \{\[per & 1\\ num & sg\]\}
\]
\end{avm}}}
		\lf{\rnode{b}{\begin{avm}
\[ mph & \{\[ph &  <wa>\]\}\\
   mud & \{\[per & 3\\ num & pl\]\}
\]
\end{avm}}}
...
%\psset{linecolor=red}
	\br{\avmbox{POSITION}}{
		\lf{\rnode{c}{\begin{avm}
\[ mph & \{\[pc & -3\]\}\\
   mud & \{subj\}
\]
\end{avm}}}
		\lf{\rnode{d}{\begin{avm}
\[ mph & \{\[pc & -1\]\}\\
   mud & \{ obj \}
\]
\end{avm}}}
...
\end{avm}}
\end{center}
\psset{arm=0pt,angleA=-90,angleB=90,
  % linecolor=blue,
  linestyle=dashed}
\ncdiag{a}{x}
\ncdiag{a}{t}
...
% \subsubsection{Extended exponence \citep{Crysmann:14:OUP}}

% Brief discussion of Nyanja pre-prefixation 


  


% \subsubsection{Heteroclisis and overabundance \citep{Bonami:Crysmann:2018}}

% Discussion of heteroclisis and overabundance in Czech

% \section{Inflectional morphology in implementation}

% Currently, there are two competing implementations 
% for typed feature structure formalisms, the TRALE system on the one
% hand, and the DELPH-IN systems on the other.   

% \begin{exe}
% \ex \label{ex:1:descartes}
