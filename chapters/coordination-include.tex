...
Consider, for example, the non-constituent \rep{constructions}{coordinations} in (\ref{lpecx}). 
...
\emph{Robin likes Sam and Tim -- Sue}.\itd{Stefan: Sometimes you use `--' and sometimes \trace
...
to account for Closest \changed{Conjunct} Agreement. Finally, in some accounts, non-constituent coordination
