...
Another source of evidence against syntactic and non-elliptical accounts of Right-Node Raising\is{Right Node Raising} is that this phenomenon can involve lexical structure,
...
Stressed pronouns, affixes that correspond to independent prosodic words, and compound parts can be Right-Node Raised\is{Right Node Raising} because  they are  independent prosodic units in their local domains.
