...
\gll kamalaa wimalaa poDugu \\ 
     Kamala Vimala tall\\
\glt `Kamala and Vimala are tall\add{.}'
\z
...
\emph{simple-coord-phr\added{ase}} \impl \\
	[dtrs & ne-list(<[coord & none]>) \+ ne-list([coord & \added{\1} crd ]) ]
}

\ex
\avm{
\emph{omnisyndetic-coord\added{-phrase}}  \impl \\
	[dtrs & ne-list([coord & \added{\1} crd ]) ]
}\label{omni}
\ex
\avm{
...
\itdobl{Clitic should be glossed by =.}
\glt `Lee and Kim'
\zl
...
\ea
\label{correlphrr}
\type{correl-\changed{phrase}} \impl\\
\oneline{%
\avm{
...
\eas
\label{rnrcx}
\type{\changed{right-peripheral-ellipsis-phrase}} \impl\\
\avm{
...
\emph{Robin likes Sam and Tim \rep{--}{\trace} Sue}.
