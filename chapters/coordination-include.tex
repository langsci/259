...
\citealt[843--844]{chavesrnr} and \crossrefchapteralt[Section~\ref{sec-ellipsis-rnr}]{ellipsis}). In French, the first conjunct cannot end with a clitic article or with a weak preposition as in (\ref{fr1}b,c), quoted from \citep[\page 14]{Abeille:06}.
...
Related work aims to achieve the same result using type-underspecification, such as 
 ...
 Finally,  
 \citet{berthold0}, \citet{yatabe},  \citet{Beavers}, and
