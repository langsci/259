...
It  preserves the \textsc{mrkg} feature when coordinants are themselves marked. The conjunction takes the adjacent conjunct as a complement. This captures its being first in head-initial languages like \ili{English}, and its final position in head-final languages like \ili{Japanese}.
\end{sloppypar}
