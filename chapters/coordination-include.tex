...
more'. \citet{Abeille:06} and \citet{Abeille:Borsley:08} propose that they are  coordinate in some languages 
 and subordinate in others. In English, one can add the adverb \emph{then}, whereas in \ili{French}, one can add the coordinandion \emph{et} (`and'). In English, the first clause can also be used as a standard adjunct (\ref{adjcc}).
