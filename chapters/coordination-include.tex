...
\gll Plus je lis (et) plus je comprends.\\
     more I read \hphantom{(}and more I understand\\
...
adapted to HPSG; see, for example, \citet{Daniels02} and \citet{Yatabe:04}.  Related work aims to
achieve the same result using type-underspecification, such as \citet{Sag:03}. Other, more
...
\begin{forest}
[\avm{VP [phon & \1 \+ \2 \+ \0 \+ \3]} 
	[\avm{VP [phon & < \type{give} > \+ \2 < \type{a, book, to, Mary} > ]}]
	[\avm{VP [phon & \0 < \type{and} > \+ \1 < \type{give} > \+ \3 < \type{a, magazine, to, Sue} > ]}
	[Coord]
	[VP] ] ]
\end{forest}
}
