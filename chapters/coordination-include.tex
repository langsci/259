...
\crossrefchapteralt[Section~\ref{agreement-sec-index-concord}]{agreement}). \citet{Moosally}\todostefan{Stefan:
...
\ex Chimpanzees hunt [frequently]\sub{AdvP} and [with an unusual degree of success]\sub{PP}.
\ex I'm planning [a four-month trip to Africa]\sub{NP} and [to return to York afterwards]\sub{VP}.
\end{exe}
...
\citet{bresnan74}, \citet[299]{wexlercull},  \citet[45]{grosu81}, \citet{mccawley},\todostefan{some have page numbers others do not. Consider adding numbers to all.} and \citet[382, fn.\ 30]{sab}
