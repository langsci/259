...
\z
%
The subject in the leftmost conjunct in (\ref{italian}) would be analyzed as a noncanonical \type{synsem} of type \textit{pro} and the correlate for the remnant \emph{Giovanni}. %and has two remnants in the gapped clause. 
