...
\ili{Bulgarian} \citep{Abels2017}, \ili{Serbo-Croatian} \citep{Stjepanovic2008, Stjepanovic2012}, \ili{Mauritian} \citet{Abeille2019}, and %Saudi 
...
verb \textit{can}, bearing the feature AUX, has a \textit{pro} VP as its second argument in a sentence like \textit{John can't dance, but Sandy can.}, that is, this VP is not instantiated as a syntactic complement of the verb.\footnote{The rich body of HPSG work on \ili{English} auxiliaries takes them not as special Infl categories, but as verbs bearing the feature AUX. See \citet{Kim:00, KS2002a, Sag:Wasow:Bender:2003, Sag2020a, kimmichaelis:2020}.} This possibility is represented formally in (\ref{51}) 
