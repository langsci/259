...
constituents of like category can coordinate.\footnote{As discussed in 
 \crossrefchapteralt{coordination} and references therein, there are numerous examples (e.g., \textit{Fred became wealthy and a Republican}) where unlike categories are coordinated.}
%\inlinetodostefan{TODO for JB: Add a source to footnote %32}
