...
\gll Ne  pas         parler    Fran\c{c}ais  est  un  grand d\'{e}savantage  en ce cas. \\
     ne \textsc{neg} to.speak  \ili{French}  is  a great disadvantage  in this case \\
...
\gll Ne  parler   pas          Fran\c{c}ais  est un  grand d\'{e}savantage en ce   cas.\\ %\addglosses (isn't this too obvious?)
     ne  to.speak \textsc{neg} \ili{French}        is  a   great disadvantage    in this case \\
}
\zl
...
\ex[]{
\gll [Ne           pas  [parler  fran\c{c}ais]]  est  un grand d\'{e}savantage  en ce cas. \\
     \spacebr{}ne  not  {}        to.speak \ili{French}  is  a great disadvantage  in this case \\
} \label{negation-34a}
\ex[*]{
\gll [Ne  parler  pas  fran\c{c}ais]  est  un  grand d\'{e}savantage en ce cas.\\
\spacebr{}ne  to.speak not \ili{French}   is  a great disadvantage  in this case\\
} \label{negation-34b}
\zl
...
that selects Adv\jbsub{\textsc{i}} as an additional complement.\footnote{As
...
\gll Ne parlant pas Fran\c{c}ais, Stacy avait des difficult\'{e}s. \\
     ne speaking  \textsc{neg} \ili{French}    Stacy   had  of  difficulties\\
\glt `Not speaking \ili{French},  Stacy had difficulties.'
}
\ex[*]{
\gll Ne pas parlant Fran\c{c}ais, Stacy avait des difficult\'{e}s.\\
     ne \textsc{neg} speaking   \ili{French}    Stacy   had  of  difficulties\\
}
\zl
...
the difference in positioning the negators in \ili{English} and \ili{French}.
...
As noted earlier, languages like \ili{Turkish} and \ili{Japanese} employ morphological negation where the negative marker behaves like a suffix (\citealt[\page 171]{kelepir} for
\ili{Turkish} and \citealt{Kato:97,Kato:00} for \ili{Japanese}). Consider
a \ili{Turkish} and a \ili{Japanese} example respectively:
% again:
...
\noindent
As shown by the examples, the sentential negation of \ili{Turkish}
and \ili{Japanese} employ
...
%Kelepir 2001
%\ili{Japanese} and \ili{Turkish} show other clear examples of morphological negation.
%
...
For example, the vowel of the \ili{Turkish} negative suffix \textit{-me} shifts from open to closed when followed by the
...
the properties of the morphological negative affix itself.
  %
 %\citet{Prz:00} focuses on the non-local genitive of negation in \ili{Polish}, where the object argument is not accusative but genitive-%marked with the presence of negative marker as in (\ref{negation-genitive-1a}). The assignment of genitive case to the object is also effective %in
...
suffix \suffix{ma} for \ili{Turkish}
and \suffix{na} for \ili{Japanese} will be attached to the
...
\gll Mimi-nun          (yehathun)           tosi-lul          (yehathun)           ttena-ci            (*yehathun) anh-ass-ta. \\
     Mimi-\textsc{top} \hphantom{(}anyway city-\textsc{acc} \hphantom{(}anyway leave-\textsc{conn} \hphantom{(*}anyway \textsc{neg}-\textsc{pst}-\textsc{decl} \\
...
a syntactic unit with a preceding lexical  verb in \ili{Korean}.
...
creating a well-formed \textsc{head-light} construct.
...
The HPSG analyses have taken the negative auxiliary in \ili{Korean}
...
\gll sakwa-lul          [[mek-ko siph-ci] anh-ta]. \\
     apple-\textsc{acc} \hphantom{[[}eat-\textsc{conn} wish-\textsc{conn} \textsc{neg}-\textsc{decl} \\
\glt`would not like to eat the apple'

\ex \label{negation-20c}
\gll sakwa-lul          [[[mek-ko siph-e] ha-ci] anh-ta]. \\
     apple-\textsc{acc} \hphantom{[[[}eat-\textsc{conn} wish-\textsc{conn} do-\textsc{conn} \textsc{neg}-\textsc{decl} \\
\glt`do not like to eat the apple'

\ex
\gll sakwa-lul          [[[[mek-ko siph-e] ha-key] toy-ci] anh-ta]. \\
     apple-\textsc{acc} \hphantom{[[[[}eat-\textsc{conn} wish-\textsc{conn} do-\textsc{conn} become-\textsc{conn} \textsc{neg}-\textsc{decl} \\
...
\gll Gianni non telefona a nessuno.\\
     Gianni \textsc{neg} telephones to nobody\\ \hfill (\ili{Italian}, \citealt[\page 62]{Borsley:06})
...
\gll Dw i ddim wedi gweld neb.\\
     am I \textsc{neg} \textsc{perf} see nobody\\ \hfill  (\ili{Welsh}, \citealt[\page 108]{Borsley:05})
...
%In the non-derivational, lexicalist analysis I propose,
...
\citet{Borsley:06}, adopting \citegen{Kathol2000a} topological approach,
 provides a linearization"=based HPSG approach to capturing the distributional possibilities of negation in \ili{Italian} and \ili{Welsh}, which we have seen
 in (\ref{negation-position-1a}) and (\ref{negation-position-1c}), respectively.
%
% and The VSO language \ili{Welsh} also has a preverbal negation but allows the multiple %realizations of negation, as in  (data from \citep{Borsley:06}).
%
...
within the analysis, the \ili{Welsh} \textsc{neg} expression \emph{ddim}, unlike \ili{Italian} \emph{non},
...
In addition to this work focusing on the distributional possibilities
 ...
 \citet{Prz:00} offers an HPSG analysis for the non-local genitive of negation in \ili{Polish}.
 In \ili{Polish}, negation is realized as the prefix \type{nie} to a verbal expression (see \citealt{PK:99, Prz:00, Prz:01}), and
 \ili{Polish} allows the object argument to be genitive-marked when the negative marker is present, as in (\ref{negation-49b}).
 %In \ili{Polish},  negation is realized as the prefix
  ...
  the unbounded relation as shown in (\ref{negation-50b}) (data from \citealt[\page 120]{Prz:00}):

\eal
\ex  \label{negation-genitive}
\gll Lubi\c{e} Mari\c{e} \\
     like.1st.\textsc{sg} Mary.\textsc{acc}\\%\hfill(\ili{Polish})
\glt `I like Mary.'
...
As for the long distance genitive in (\ref{negation-genitive-1}), \citet[\page 145]{Prz:00}
...
reading for standard \ili{French}, inducing double negation as in (\ref{negation-qstore}):\footnote{See \citet{Swart:02} for cases where \textit{pas} induces negative concord.}
...
derivational perspective on negation has been that one uniform category,
...
related or not. However, this line of thinking runs the risk of
...
In the non-derivational HPSG analyses for the four main
...
and the non-derivational, lexicalist view as a matter
...
But in the non-derivational view,  it is both the morphological
...
the earlier version. My thanks also go to Okgi Kim, Rok Sim, and Jungsoo Kim for
helpful feedback.
