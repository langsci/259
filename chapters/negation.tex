...
\begin{exe}
\ex \begin{xlist}
\ex {\gll Robin  n'aime  pas Stacey. \\
...
\ex French:
  \xytree{\small
    & \xynode[-1,1]{TP}
    \\
    \xynode{Tns} & & \xynode[-1,1]{NegP}
    \\
    & \xynode{pas} & & \xynode[-1,1]{Neg$'$}
    \\
    & & \xynode[0]{Neg} & & \xynode[-1,1]{AgrP}
    \\
    & & \xynode{ne} & \xynode[0]{Agr} & & \xynode[-1,1]{VP}
    \\
    & & & \xynode{t}
    \xyconnect[.>][^3pc](L,D){-4,-3}
    & \xynode[0]{V} & & \xynode{...}
    \\
    & & & & \xynode{all verbs}
    \xyconnect[.>][^2pc](D,D){-1,-1}
  }
...
\ex English:
 \xytree{\small
    ...
    & \xynode[0]{Neg} & & \xynode[-1,1]{AgrP}
    \\
    & \xynode{not} & \xynode[0]{Agr} & & \xynode[-1,1]{VP}
    \\
    & & \xynode{t}
    \xyconnect[.>][^2.5pc](L,D){-3,-2}
    & \xynode[0]{V} & & \xynode{...}
    \\
    & & & \xynode{have/be}
    \xyconnect[.>][^2pc](D,D){-1,-1}
...
and \citet{Cinque:99} (e.g., {\it embrasse souvent} vs.\ {\it often kisses}).\index{interpretable}
...
\begin{exe}
\ex \begin{xlist}
\ex \label{15a}\xytree[3.5]{\small  &             &\xynode[-1,1]{VP} \\
             & \xynode[-1,1]{VP}  &                &\xynode[0]{V[\AUX\ +]}\\
\xynode{...} &  &\xynode{V[\VFORM\ {\it ci}]}&\xynode{\bt anh-ta\\ `\NEG-\DECL' \et}
}

\ex \label{15b}\xytree[3.5]{\small             &\xynode[-1,1]{VP}\\
  \xynode{...}  &                      &\xynode[-1,1]{V} \\
                 &\xynode[0]{V[\VFORM\ {\it ci}]}&&\xynode[0]{V[\AUX\ +]}\\
        &\xynode{...}&  &\xynode{\bt anh-ta\\ `\NEG-\DECL' \et}}
\end{xlist} \end{exe}
...
\begin{exe}
\ex \small\evnup{\xytree[3.7]{ & \xynode{\begin{myavm}\avml \hfil V$'$\\
          \[\textit{hd-lex-cxt }\\
          \HEAD\   \@3\\
          {\LITE\  +}\\
          \COMPS\  \q<{\@2NP}\q>\]
           \avmr \end{myavm}}
      \xyconnect{1,-1}"_{Lexical Arg.}"\xyconnect{1,1}"^{H}" \\
      \xynode[0]{\begin{myavm}\avml \hfil {\@1V}\\
          \[\HEAD\ \[\VFORM\  \textit{ci}\\
          {\LITE\  +}\\
           \COMPS\  \q<{\@2NP}\q>\]\]\avmr \end{myavm}} & &
      \xynode[0]{\begin{myavm}
          \avml \hfil V\\
          \[\HEAD\  \@3\\
           %\SUBJ\ \; \q<\@2NP\q>\\
          \COMPS\; \q<{\@1V}\q>%\\
          %\ARG-ST\ \; \q<\@2, \@1\q>
          \]\avmr \end{myavm}} \\
      \xynode{\bt ilk-ci \\ read-\conn \et} & \xynode{} & \xynode{\bt anh-ass-ta \\ \NEG-\PST-\DECL \et}}}
\end{exe}
...
\begin{exe}
\ex \small\evnup{\xytree[3.8]{ & &
      \xynode[-1,2]{\begin{myavm}
          \avml \hfil VP\\[-1ex]
          \avmr
        \end{myavm}}
      \\
     & \xytrinode[0]{\begin{myavm}\@2NP\end{myavm}}  & & &
      \xynode[-1,1]{\begin{myavm}
          \avml \hfil V$'$ \\[-1ex]
          \[ \HEAD\  \textit{verb}\\
          %\SUBJ\  \q<\@1\q> \\
          {\COMPS\  \q<\@2\q>}
          \]\avmr\end{myavm}}
      \\
     & \xynode{\bt sakwa-lul\\ apple-\acc \et}  & &
      \xynode[-1,1]{\begin{myavm}
          \avml \hfil \@5V$'$\\[-1ex]
          \[\VFORM\  \textit{ci}\\
            {\COMPS\  \q<\@2\q>}
      ...
      \xynode[0]{\begin{myavm}
          ...
          \VFORM\  \textit{ci}\\
            \COMPS\  \q<\@3\q>
          \] \avmr\end{myavm}}
      & \xynode{\bt anh-ass-ta \\ \NEG-\pst-\decl \et}
      \\
      & \xynode[0]{\begin{myavm}
          \avml \hfil \@7V\\[-1ex]
          \[\VFORM\  \textit{ko}\\
      ...
      & & \xynode[0]{\begin{myavm}
          ...
          \COMPS\  \q<\@7\q>
          \]\avmr\end{myavm}} &
      \xynode{\bt ha-ci\\ do-\conn \et} \\
      & \xynode{\bt mek-ko \\ eat-\conn \et} & & \xynode{\bc siph-e \\ wish-\conn \et}}}
\end{exe}
...
\be
\ex[]{\label{not-two} The president could not approve the bill.
}
\ee
%
...
\ex \begin{xlist}
\label{vpe-not-ex}\ex[]{
Mary sang a song, but Lee never did \tr.
}
\ex[*]{
Mary sang a song, but Lee did never \tr.
}
\ex[]{
Mary sang a song, but Lee did not \tr.
}
\end{xlist}
\ee
...
\ex \xytree[4]{\small
    &    & \xynode[-1,1]{VP}
    \\
    &\xynode[-1,1]{\begin{avm}\avml \hfil V$'$\\
    \[{\it hd-lex-cxt}\\
      \AUX\ +\]\avmr\end{avm}}&                 &\xytrinode{\begin{avm} VP\end{avm}}\\
\xynode[0]{V}&   &\xynode[0]{\begin{avm}Adv[\NEG\ +]\end{avm}}       &\xynode{leave  town}\\
      \xynode{could}& &\xynode{not}}
\ee
...
%
%What this implies is that the sentential negator {\it not}, just like particles,
%bears the feature \LEX, so that it can be selected by a finite auxiliary verb:

\be
\ex \label{neg-rule} Negative Auxiliary Construction ($\uparrow${\it post-infl-cxt}): \\ \small\evnup{
\xytree[2]{
 &&&\xynode[0]{ \begin{avm}
 \[{\it neg-fin-aux}\\
\SYN\[\HEAD\[\AUX &+\\
...
\be
\ex \xytree[3.5]{\small
    &    & \xynode[-1,1]{\begin{avm}\avml \hfil VP\\ \[\VFORM\ \type{fin}\\
                                               \AUX\ $+$\\
                            \COMPS\ \q< \; \; \q>\]\avmr
                    \end{avm}}    \\
    &\xynode[-1,1]{\begin{avm}\avml \hfil V\\
        ...
        \AUX\ $+$\\
        \COMPS\ \q<\@3VP\q>\]\avmr
      \end{avm}}&                 &\xytrinode{\begin{avm} \@3VP\end{avm}}\\
\xynode[0]{\begin{avm}\avml \hfil V\\
        \[\VFORM\ \type{fin}\\
          \AUX\ $+$\\
          \COMPS\ \q<\@2[\NEG\ $+$], \@3VP\q>\]\avmr
      \end{avm}}&   &\xynode[0]{\begin{avm} \@2Adv \end{avm}}       &\xynode{leave town}\\
      \xynode{could}& &\xynode{not}}
\ee
...
\be
\ex \xytree[3]{\small
       &\xynode[-1,1]{\begin{avm}\avml \hfil V$'$\avmr \end{avm}}\\
              \xynode[0]{\begin{avm}
              \avml \hfil V\\
\[\HEAD\|\AUX\ \ \ +\\
  \VAL\[\SPR\ \q<\@1\q>\\
  \COMPS\ {\q<\@2Adv[\NEG\ +]\q>}\]\\
  \ARG-ST\  \q<\@1, \@2, VP[\type{bse}]\q> \]\avmr\end{avm}}&  &\xynode[0]{\begin{avm}
  \avml \hfil \@2Adv\\
  \[\NEG\ +\] \avmr\end{avm}}
  \\
 \xynode{could}  & & \xynode{not}}
...
\ex \xytree[2]{\small
                      &\xynode[-1,1]{VP}\\
  \xynode[0]{V[\AUX\ +]}&  &\xynode[0]{*VP}\\
  \xynode{could}&          &\xynode[0]{\begin{avm}Adv[\MOD\  \q<VP\q>]\end{avm}}\\
                    &       &\xynode{never}}
\ee
...
\xytree[2]{\small
 ...
 \SYN\[\HEAD\[%\AUX &+\\
        ...
        \NEG\ &+
        \]\]\\
\ARG-ST\ \q<\@1XP\q> \  $\oplus$ \ \<Adv\ssub{I}\> \ $\oplus$ \ {\it L}\]\end{avm}}\\
&&&\xynode{\begin{avm}
\[{\it fin-v}\\
 \FORM\ \q<\@2\q>\\
\SYN\|\HEAD\|\VFORM\ \type{fin}\\
\ARG-ST\ \q<\@1XP\q> \ $\oplus$ \ {\it L}\] \end{avm}}}
\ee
...
the input verb (\boxit{2}) as its argument.
...
&&&\xynode[0]{ \begin{avm}
 ...
 \SYN\[\HEAD\[%\AUX &+\\
        ...
        \NEG\ &+
        \]\]\\
\ARG-ST\ \<\@1NP, Adv\ssub{I}\[\LEX\ +\\
                                   \NEG\ +\], \@2NP\>\]\end{avm}}\\
&&&\xynode{\begin{avm}
\[{\it fin-v}\\
 \FORM\ \q<aime\q>\\
\SYN\|\HEAD\|\VFORM\ \type{fin}\\
\ARG-ST\ \q<\@1NP, \@2NP\q>\] \end{avm}}}
\ee
...
\be
\ex \label{55} \small\evnup{\xytree[3.9]{\small
         & \xynode[-1,1,2]{\begin{avm} \avml \hfil VP\\
\[\HEAD\|\VFORM\ \type{fin}\\
  \SUBJ \q<\@1NP\q>\\
  \COMPS \q< \; \q>\] \avmr \end{avm}}\\
\xynode[0]{\begin{avm} \avml \hfil V\\
\[{\it neg-fin-v}\\
 \HEAD\|\VFORM\ \type{fin}\\
  \SUBJ \q<\@1NP\q>\\
  \COMPS \q<\@2Adv\ssub{I}, \@3NP\q>\\
\ARG-ST\ \<\@1NP, \@2Adv\ssub{I}, \@3NP\> \] \avmr \end{avm}}
 && \xynode[0]{\begin{avm}\@2Adv\ssub{I}\end{avm}} &\xynode[0]{\begin{avm}\@3NP\end{avm}}\\
     \xynode{n'aime}   &                & \xynode{pas} & \xynode{Stacy}}}
\ee
...
%the positioning of the negative markers {\it pas} and {\it not}.
...
As we have seen,  the negative markers {\it non} and {\it no} are
...
Various properties of the negator {\it non} in Italian
and {\it no} in Spanish are shared with those of pronominal
clitics. Like pronominal clitics, the Italian negator {\it non} must
...
that negators {\it non} in Italian and {\it no} in Spanish can appear alone,
...
%of {\it non} (clitic and non-clitic properties). But
...
Gianni non legge articoli di sintassi. \\
Gianni \textsc{neg} reads articles of syntax \\
\trans `Gianni doesn't read syntax articles.'} \label{66}
\ee
...
\be
\ex \xytree[5.5]{\small
    &    & \xynode[-1,1]{\begin{avm}\avml \hfil VP\\ \[
    \VFORM\ \type{fin}\\
                             \COMPS\ \q< \; \; \q>\]\avmr
                    \end{avm}}    \\
    &\xynode[-1,1]{\begin{avm}\avml \hfil V$'$\\
        ...
        \VFORM\ \type{fin}\\
        \COMPS\ \q<\@2NP\q>\]\avmr
      \end{avm}}&                 &\xytrinode{\begin{avm} \@2NP\end{avm}}\\
\xynode[0]{\begin{avm}\avml \hfil V\\
        \[\SEL\ \q<\@1V\q> \]\avmr
      \end{avm}}&   &\xynode[0]{\begin{avm} \avml \hfil \@1V\\
        \[\VFORM\ \type{fin}\\
          \COMPS\ \q<\@2NP\q>\]\avmr
    \end{avm}}       &\xynode{articoli di sintassi}\\
      \xynode{non}& &\xynode{legge}}
\ee
