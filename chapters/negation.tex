...
\medskip
\noindent As shown here, the negative finite auxiliary verb \type{could} selects two complements, the negator \emph{not} and the VP \emph{leave town}. The finite auxiliary then first combines with the negator, forming a well-formed head-lex construct. This construct then can combine with a VP complement, forming a Head"=Complement
construct.
