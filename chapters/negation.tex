...
ne.have \textsc{neg} a car      in   this city  make the life difficult\\\todostefan{translation missing}
} \label{negation-28b}
\zl
...
illustrated in (\ref{negation-30}) and (\ref{negation-31}) \citep{Klima:64, Baker:89,Baker:91,Kim:00,kimmichaelis:2020}.
...
specified by the following lexical rule \citep{Kim:00,kimmichaelis:2020}:
