...
\ChapterDOI{10.5281/zenodo.13644962}
...
\author{Jong-Bok Kim\orcid{0000-0003-3286-0446}\affiliation{Kyung Hee University, Seoul}}
\title{Negation}
...
much like the negative adverb \textit{never}. The similarity between \emph{not} and \emph{never} is particularly clear in non-finite verbal
...
seen from an attested example like \textit{I, being the size I am, could hide as one of them, whereas she could never}, in a limited context the adverb \textit{never} is stranded
after a modal auxiliary, but not after a non-modal auxiliary verb like \textit{be, have}
and \textit{do}. Such a stranding seems to be possible when the adverb
