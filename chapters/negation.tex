...
the auxiliary negative verb, and
...
\inlinetodostefan{Page numbers are missing, Stefan will mark necesary additions in the final read. }
...
possibilities that we can observe in an example like (\ref{negation-not-two}) (see \citealt{Klima:64, Baker:91, Warner2000a-u},\citealt[\page 200]{kimmichaelis:2020}).\footnote{\citet{Warner2000a-u} and \citet{BL:13}
...
specified by the following lexical rule (\citealt{Kim:00},\citealt[\page 209]{kimmichaelis:2020}):
...
Bob Borsley and Stefan M\"{u}ller for constructive comments on
