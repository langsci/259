...
The same problem occurs even more dramatically in \isi{\textit{pro}-drop} languages.  Many languages
...
\gll   Ces	ciseaux	sont	g\'{e}niaux!	(*g\'{e}nial!) \\
		these.\textsc{pl}	scissors(\textsc{m.pl})	are.\textsc{pl} 	brilliant.\textsc{m.pl}	\hspaceThis{(*}brilliant.\textsc{m.sg} \\
