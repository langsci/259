...
\ChapterDOI{10.5281/zenodo.13645101}
...
\begin{exe}
\ex\label{ex-gender-agreement-historical-development}
\begin{xlist}
...
\gll a-matyi a=minbadi\\
     \textsc{anim}=kangaroo \textsc{anim}=big\\
\glt `a big kangaroo'
...
\ex 
\gll Hus-et 	är	gott. \\
     house-\textsc{def.n.sg}	be.\textsc{prs}	good.\textsc{n.sg} \\\hfill(\ili{Swedish})
...
\gll   Pannkak-or 	är	gott. \\
	pancake-\textsc{pl}	be.\textsc{prs}	good.\textsc{n.sg} \\\hfill(\ili{Swedish})
...
\gll Att äta pannkakor är gott. \\
     to eat pancakes be.\textsc{prs} good.\textsc{n.sg}  \\\hfill(\ili{Swedish})
