...
The \term{Type Raising} (TR) and \term{Function Composition} (FC) rules are defined as in
...
\ex\label{FC} \begin{multicols}{2}
  \begin{xlist}
      \ex\mbox{Forward FC}\\[.5\baselineskip]
\begin{prooftree}
\hypo{\LexEnt{\pt{\ptv{a}}}{\sem{ \sF}}{\syncat{\textit{A}\ensuremath{/}\textit{B}}}}
...
\end{prooftree}
\columnbreak
\ex\mbox{Backward FC}\\[.5\baselineskip]
\begin{prooftree}
...
\begin{exe}
 \ex\label{RNR-CCG-DV}
\attop{\begin{prooftree}\footnotesize
\hypo{$\vdots$}
