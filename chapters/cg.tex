...
the first to recast the Lambek calculus in this labeled deduction
format.}
...
a more sophisticated treatment in TLG (see \citealt[Section~9.7]{Carpenter98a-u}
...
by the vertical slash in this analysis.\footnote{It is hard to tell
  ...
  \crossrefchaptert[Section~\ref{rc:sec-internal-structure}]{relative-clauses} emphasize the difference between these two types
...
literature (of the sort found in \citew{MuellerGT-Eng1}) and the
