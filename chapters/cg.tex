...
\abstract{This chapter aims to offer an up-to-date comparison of HPSG and
 ...
 human sentence processing. Throughout the discussion, I  attempt to 
...
Stefan: Ah, ok. But why is this done? And how? Is it functor last?}
...
directional variants of implication (that is, both \syncat{\textit{A}\ensuremath{/}\textit{B}} and
...
Stefan: The line break seems worth exploring.}
\end{figure}
%\noindent 
...
nonconstituents in RNR and ACC are analyzed),\itdopt{Why is it
  different? \\ Yusuke: I've added clarification in parentheses.\\Stefan: OK. But the slash is
  always saying: I need X, isn't it? So it is like valence. It is true that analyses are different
  sometimes, but i do not see a fundamental difference. Maybe I am missing things.}
