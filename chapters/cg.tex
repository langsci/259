...
disambiguation is obvious---for example, \syncat{\textit{A}\ensuremath{\backslash}{}\textit{A}\ensuremath{\backslash}{}\textit{A}} is an abbreviation for \syncat{(\textit{A}\ensuremath{\backslash}{}(\textit{A}\ensuremath{\backslash}{}\textit{A}))}.}
...
\citep[Chapter~4, Section~4.2]{Steedman2000a-u} and parasitic gaps \citep{Steedman87a-u}.
...
a more sophisticated treatment in TLCG (see \citealt[Chapter~9, Section~9.7]{Carpenter98a-u}
...
\citet[Chapter~3, Section~3.1]{KubotaLevineBook} note some
...
example, \citealt{SW2011a}, \citealt[Chapter 13, Section 13.7]{steedman2012} and
