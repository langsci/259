...
\crossrefchapteralt{minimalism}\itdobl{Which section?\\Yusuke: When I
  looked at your chapter again, I now notice that it's much more 
  ruthless on minimalism than I thought it was. So, it may be somewhat
  misleading to quote it in this context. What do you think? I want to
cite everything relevant, but I don't cite people in inappropriate ways.}
...
interaction currently exists in the HPSG literature.\itdopt{Really?}
...
\itdopt{But this is a semantic binding theory and it fails because of binding and passive, doesn't
  it? I discuss this in the Binding chapter.}
\end{figure}
...
in which  the proper noun\itdobl{It is not just proper nouns, is it?} appears. In fact,
