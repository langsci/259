...
\ea[*]{\label{overg}
a$_{\mathrm{NP/N}}$ [$_{\mathrm{N/N}}$ powerful$_{\mathrm{N/N}}$ by Rivaldo$_{\mathrm{N\backslash N}}$] shot$_{\mathrm{N}}$ 
}
\z
...
\begin{samepage2}
\ea\label{proof}%
\resizebox{\linewidth}{!}{\begin{minipage}[t]{\textwidth}%
\def\proofSkipAmount{\vskip 0pt}%
\begin{prooftree}\vskip-.6\baselineskip\hskip-1.75em%
\DerivSize%
