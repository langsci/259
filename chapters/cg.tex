...
literature (see, for example, \citet{Morrill94a-u,pogodallapompigne2011})
...
\begin{exe}
 \ex\label{SE-rev} %\\[-15pt]
     \begin{multicols}{2} 
\begin{xlist}
 \ex\label{rsetwo} \mbox{Forward Slash Elimination}
...
\end{prooftree}
 ...
 \ex\label{lsetwo} \mbox{Backward Slash Elimination} 
...
\citet[Section~2.2.5, pp.~46--49]{jaeger05}) are now derivable as theorems. As an
...
equivalent---see, for example, \citet{Carpenter98a-u} and \citet{jaeger05}).
...
(see, for example, \citet{MWArgSt} and \crossrefchaptert{cxg}; see also
...
cross-serial dependencies; see also \citet{Dowty97a-u} for an accessible
...
\citet{Dowty97a-u} for a critique of
