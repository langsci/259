...
In the example of (\ref{PrincipleZ}), for instance, the \ili{Portuguese} long-distance reflexive {\em ele pr\'{o}prio},
...
the \ili{Portuguese} nominal {\em ele pr\'{o}prio} complies with 
...
\begin{exe}
\ex
		\gll O m\'{e}dico$_{i}$ disse-me [que [o director do Pedro$_{j}$]$_{k}$ ainda n\~{a}o reparou [que $\emptyset_{*i/*j/k}$ cometeu um erro]]. (\ili{Portuguese})\\
...
%\begin{exe}
%\ex
%\gll *Sich$_{i}$ friert. (\ili{German})\\
...
deles pr\'{o}prios$_{*i}$. (\ili{Portuguese})\\ 
...
see \citep{huangTang:longdistance91, xue:ziji94} about \ili{Chinese} {\em ziji}, among others.}
%
...
%
\footnote{
For an analysis of the Subject-orientedness of \ili{French} {\em se} resorting
...
the relevant anaphoric units (e.g. the \ili{English} pronoun {\em him}, or the \ili{Portuguese} multiword long distance reflexive {\em ele pr\'{o}prio}) or the anaphora inducing items (e.g. the \ili{English} definite article {\em the} that introduces non-pronouns).
...
the square of duality in (\ref{patternSquareDuality}) --- with the semantic values of the \ili{English} 
