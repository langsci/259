...
the relevant anaphoric units (e.g. the English pronoun {\em him}, or the \ili{Portuguese} multiword long distance reflexive {\em ele pr\'{o}prio}) or the anaphora inducing items (e.g. the English definite article {\em the} that introduces non-pronouns).
