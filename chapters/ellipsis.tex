...
The different types of fragments are derived from the \citet[333]{Ginzburg:Sag:2000} hierarchy of clausal types depicted in (\ref{cltypes}):


\begin{figure}[H]
\begin{center}
%\includegraphics[scale=0.4]{GShierarchy.png}
\includegraphics[height=5.5cm, width=10cm]{GShierarchy.png}
\end{center}
\caption{Clausal hierarchy for fragments (\citealt[333]{Ginzburg:Sag:2000})}\label{cltypes}
\end{figure}
%
%
%
