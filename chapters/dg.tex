...
%
\draw[->] (3rd.north) to[bend left] (give.north);
\draw[->] (7.3,-1.63) to[bend right] (mother.north);
\draw[->] (7.7,-1.63) to[bend left] (milk.north);
\draw[->] (9.7,-1.63) to[bend right] (-.2,-1.63);
...
%lower row
\node[draw,inner sep=.3cm](1b)[below of=1a]{};
\node[draw,inner sep=.3cm](1c) at (3.5,1){};
\node[draw,inner sep=.3cm](1d) at (1,1){};
%arrows with ellipses
%ellipses with words
\draw[->] (aux.north) to[bend right] node[draw,ellipse,fill=white](prec){\strut preceder} (one.north);
\draw[->] (aux.north) to[bend left] node[draw,ellipse,fill=white](desc){\strut descendant} (1a.north);
%ellipses with <
