...
\end{forest}
	\caption{A verb-rooted tree from Brassai (1873) quoted from \citew{ImrenyiVladarTBA}}
	\label{fig:3}
...
\citep{ImrenyiVladarTBA}, is in Figure~\ref{fig:3}. The awkward horizontal braces \todosatz{Stefan: Please
  add braces.} should not be seen as a nod in the direction of classical PS given that the bracketed words are not even adjacent in the sentence analysed. Kern’s tree in Figure~\ref{fig:4}, on the other hand, is for the German sentence in (\ref{ex:2}).
