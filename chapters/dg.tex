...
%
, including the famous Reed-Kellogg diagrams which are still taught (under the simple name ``diagramming'') in some American schools \citep{ReedKellog1890}; indeed, there is a website which generates such diagrams; one is reproduced in Figure~\ref{fig:2}.%
%
...
\end{forest}
\caption{A verb-rooted tree from Brassai (1873) quoted from \citew{ImrenyiVladarTBA}}\label{fig:3}
\end{figure}
