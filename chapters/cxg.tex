...
that the notion of a construction is needed for adequate models of grammar, that is, for models of
...
implementations. The macros were abbreviatory devices and did not play any role for the theory.
...
information on the mother node, that is, that \head features are shared.
