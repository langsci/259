...
\itd{Cite \crossrefchaptert[\page \pageref{evolution:page-sbcg-vs-lingo}]{evolution} on similarity of HPSG and SBCG.}
...
MGG does not make reference to inheritance hierarchies. HPSG\label{cxg:page-HPSG-inheritance} did this right from the beginning in 1985 \citep{FPW85a} for lexical items and
