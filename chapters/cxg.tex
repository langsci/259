...
%  believe Jackendoff argues against this, and Newmeyer and I did here: \citet{BN2009a}}
\begin{table}
\oneline{%
...
not the focus of work in \isi{Mainstream Generative Grammar (MGG)}.\footnote{
  ...
  Generative Grammar in a wider sense, see for example \citet*[\page 501]{FKoC88a} and \citet[\page 36]{Fillmore88a}.%
...
idioms are assigned.
%\todostefan{Anne: \citet{CvCHHLT2018a-ed}} 
...
\citet{KoenigE99a-u} on Categorial Grammar, \citet*[\page 143]{GKPS85a} on GPSG, \citet[\page
  67]{Bresnan2001a} on LFG, \citet{Bender2000a} and \citet*[\page 464]{SWB2003a} on HPSG/Sign-Based
...
\citet{FPG2006a,FPAG2007a} on input-based language acquisition.
...
\citep*{ADT2008a,AGT2014a}.\footnote{
  See \citet[\page 516]{Toivonen2013a} for an explicit reference to construction-specific phrase
...
see Section~\ref{cxg:sec-sbcg} and \citet[Section~10.6.2]{MuellerGT-Eng1}.\is{Construction Grammar!Berkeley|)}\is{Construction Grammar!Sign-Based|)}
...
[bar-adj
  ...
  [intr-bar-adj
    ...
    [\ldots]]]
\end{forest}}
\caption{\label{fig-bar-Riehemann}Parts of the type hierarchy for \bard adapted from \citet[\page 15]{Riehemann98a}}
\end{figure}
