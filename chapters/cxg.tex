...
not the focus of work in \isi{Mainstream Generative Grammar (MGG)}\footnote{
  ...
  Generative Grammar in a wider sense, see for example \citew*[\page 501]{FKoC88a}.%
}. MGG is usually concerned with
...
\inlinetodostefan{Rui: In Top-down Phase-based Minimalist Grammar
(TPMG) as developed by \citet{Chesi2004a-u,Chesi2007a-u}, and \citet{BC2006a-u,BC2012a-u}, there is no movement.
Rather, wh-phrases are linked to their ``in situ'' positions with the
aid of a short-term memory  buffer that functions like a stack. See
also \citet{Hunter2010a-u} and \citet{Hunter2018a-u} for a related account where the
information about the presence of a wh-phrase is percolated in the
syntax tree, like in GPSG/HPSG. These references may be of use here.
}
...
I thank Bob Borsley and Rui Chaves for comments on an earlier version of this paper.
