...
Grammars are (Section~\ref{sec-cxg}), I will explain why HPSG as developed in \citew{ps,ps2} was a
...
\begin{sloppypar}
\begin{itemize}
\item Berkeley Construction Grammar\is{Construction Grammar!Berkeley} \citep{Fillmore85a,Fillmore88a,KF99a,FriedHSK}
...
The toplevel is the outermost level. So in (\mex{0}), \textsc{phonology} and
...
of the head daughter \iboxb{2} and the remainder of the \compsl \iboxb{1} is identical to the
...
two lists. For further details see \crossrefchaptert{properties}.
