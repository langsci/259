...
complementizers and finite verbs in initial position in \ili{German} form a natural class. HPSG can
...
daughters within the \textsc{daughters} feature, \citet{Sag97a} represented the daughters and constraints upon them at
the top level of the sign\footnote{
The top level is the outermost level. So in (\mex{0}), \textsc{phonology} and
\textsc{syntax-semantics} are at the top level.}. 
...
monotonic (non-default)'', but if the \textsc{syn} value of the mother is not identical and
...
are more specific than what is usually used in other variants of HPSG.\footnote{
  ...
  HPSG \parencites[Section~8.5.3]{ps2}[\page 24, Fn.~1]{Mueller99a}.\itd{JP: You should reference Tony’s thesis (1996) which addresses this issue at length}
}
...
\suffix{bar} attaches to this phrase. It follows that information about valence has to be present at
the stem. 
\end{sloppypar}
...
1993 WCCFL paper and thesis
\citep{KJ94a-u,Koenig94a-u,Koenig99a}. Riehemann called her framework \emph{Type-Based Derivational
...
\label{ex-schema-bar}
%\begin{tabular}[t]{@{}l@{}}
Schema for productive adjective derivations with the suffix \suffix{bar} in\\ \ili{German} according to
...
\itd{refs in footnotes do not work}
\ea
