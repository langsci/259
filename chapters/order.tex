...
\ili{English} allow adjuncts to precede or follow the head they modify. Schema~\ref{schema-head-adjunct} does not say anything
...
\zl
The generalization about languages like \ili{English} is that adverbials can attach to the left or to the
...
on the one hand in order to capture the similarity in \ili{English} between combinations of subjects with VPs and 
