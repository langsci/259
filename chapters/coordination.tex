...
\inlinetodostefan{no source for (\mex{1}c). State sources in main text or provide source below (\mex{1}c).}
\begin{exe}
 \ex
\begin{xlista}
\ex  
...
speakers as the example in (\mex{1}c) from \citew[\page 23]{Abielle2006a} shows.
\eal
