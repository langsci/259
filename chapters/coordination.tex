...
As observed by \citet[186]{Corbet91}, many languages including \ili{Romance}, \ili{Celtic}, \ili{Semitic} and \ili{Bantu} languages, also have another strategy, namely partial agreement with only one conjunct, the one closest to the target, called \emph{closest conjunct agreement} (CCA)\is{agreement!closes conjunct}. 
...
\gll certaines          / *   certaines collectivités et organismes publics \\
     certain.\F.\PL{} {} {} certain.\F.\PL{} collectivity.\F.\PL{} and organism.\M.\PL{} public.\M.\PL{} \\
...
\glt  `Gwenllian and I have not been paid.' \citep[\page ex (12)]{Sadler2003a-u}\todostefan{Stefan:
...
\citet[843--844]{chavesrnr} and \crossrefchaptert{ellipsis}\todostefan{Stefan: add a label to the page/esection in ellipsis.tex}). In French, the first conjunct cannot end with a clitic article or with a weak preposition as in (\ref{fr1}b,c), quoted from \citep[\page 14]{Abeille:06}.
...
\comps lists as it is for complex predicates, see \crossrefchaptert[Section~\ref{complex-predicates-sec-argument-attraction}]{complex-predicates}) 
  ...
  [XP
    ...
    [XP
      ...
      [XP
        ...
        [PP [to Sue, roof]]]]]]
\end{forest}
\caption{Add a caption}\ref{fig-give-a-book-to-mary-and-a-mag-to-sue}
\end{figure}
\inlinetodostefan{Something is missing here. Are these clusters coordintated? And then the verb
  takes the coordination as argument? Maybe a figure would be good. 05.05.2020 I added Figure~\ref{fig-give-a-book-to-mary-and-a-mag-to-sue}, but the
  figure has to be explained in the text. I still do not understand what is going on.}
