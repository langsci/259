...
Second, as \citet{ross67}\addpages originally noted, the natural intonation break occurs before the coordination lexeme rather than between the coordinator and the coordinand, so that a  prosodic constituent is formed.
...
\begin{figure}
    \hfill
    \Tree[.X [.{Adv} \emph{both} ]  [.X X [.X [.{Coord} \emph{and} ]  X ] ] ]
\hfill
    \Tree[.X [.X [.{Coord} \emph{et} ]  X ] [.X [.{Coord} \emph{et} ]  X ] ]
\hfill\mbox{}
...
\inlinetodostefan{The glosses do not match. I can't do this.}
...
due to \citet{levineetal}.\addpages 
...
\end{figure}
\inlinetodostefan{The conjunction is missing in the figure and in the constraint.}
