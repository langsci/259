...
\ex {\it coord} A {\it coord} B {\it coord} C \hfill (omnisyndenton)
...
\begin{exe}
\ex {\sc Coordination Construction} (preliminary)
...
\begin{exe}
 \ex
	\begin{avm}
	\textup{\it asymmetric-cc-cx} $\rightarrow$ %{\it assymetric-correl-cx} \& 
	\[hd-dtr \@{1}\\
...
$\rightarrow$ %{\it symmetric-correl-cx} \& 
...
VP\[subj \hspace{5pt} $\langle$ \@{2} $\rangle$\\
               comps  $\langle$ $\rangle$\]
\end{avm}} \qroof{\it ate cheese pizza }.{
\begin{avm}
VP\[subj \hspace{5pt} $\langle$ \@{2} $\rangle$\\
               comps  $\langle$ $\rangle$\]
\end{avm}} \qroof{\it and drank soda}.{
\begin{avm}
VP\[subj \hspace{5pt} $\langle$ \@{2} $\rangle$\\
               comps  $\langle$ $\rangle$\]
\end{avm}} ] ]}
...
\ex \gll Ta dobra deca su do\v{s}-l-a\\
         that.{\sc sing-fem} good{\sc sing.fem} children {\sc aux}{\sc 3-pl} come{\sc pprt.pn}\\
...
\textsc{likes} bagels and Mia \textsc{hates} bagels}.{\,}} ] }
    ...
    \caption{Analysis of {\it Kim likes, and Mia hates, bagels}}\label{rnrt}
\end{figure}
