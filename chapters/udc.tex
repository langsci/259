...
\begin{figure}[h]
  ...
  \caption{\label{fig:UDC:12}Representation of gaps}
...
\begin{figure}[htb]
 ...
 \end{avm}
  ...
  \caption{\label{fig:UDC:16}Head-filler phrase (singleton \textsc{slash} set)}
...
\begin{figure}[htb]
  ...
  \caption{\label{fig:UDC:17}Head-filler phrase}
...
\begin{figure}[htb]
  ...
  \caption{\label{fig:UDC:32}\textsc{slash} Amalgamation Principle}
...
\begin{figure}[htb]
  ...
  \begin{avm}
    ...
    \caption{\label{fig:UDC:53}Lexical representation of \textit{tough} adjectives (preliminary)}
...
\begin{figure}[htb]
  ...
  \caption{\label{fig:UDC:54}Lexical representation of \textit{tough} adjectives (final)}
...
\begin{figure}[htb]
  ...
  \caption{\label{fig:UDC:59}Lexical representation of relative complementiser
    \textit{that}}
