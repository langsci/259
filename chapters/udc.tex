...
\begin{xlist}
  \ex[]{\gll [Über Syntax]$_i$  hat Max sich [ein Buch  \_$_i$ ] ausgeliehen.\\
    ...
    \glt `It's about syntax that Max has borrowed a book.' \citep[148]{kuthy01}}
  \ex[*]{\gll [Über  Syntax]$_i$  hat Max [ein Buch  \_$_i$ ] geklaut.\\
    \spacebr{}about syntax has he \spacebr{}a book {} {} stolen\\
    \glt `It's about syntax that he has stolen a book.' \hfill \citep[148]{kuthy01}}
\end{xlist}
\end{exe}
