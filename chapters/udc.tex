...
sm edges without translation
	[{S[\textsc{slash} \menge{}]}
		...
		[{S[\textsc{slash} \menge{ \ibox{1} }]}
			[V[did]]
			[NP[you]]
			[{VP[\textsc{slash} \menge{ \ibox{1} }]}
				[{V[\textsc{slash} \menge{ \ibox{1} }]} [put]]
...
sm edges without translation
	[{S[\textsc{slash} \menge{} ]}
		[{NP[\textsc{local} \ibox{1}]} [what]]
		[{S[\textsc{slash} \menge{ \ibox{1} }]}
			[{V[\textsc{slash} \menge{ \ibox{1} }]} [did]]
...
\begin{exe}
  ...
  \glt `They rested.' \hfill \citep{}\label{ex:UDC:Hau:intr}
...
\citet[Cahpter~2.3.2]{Levine:Hukari:06} argue that it is unsatisfactory. More generally, they
...
sm edges without translation
	[S
		...
		[{S[\textsc{slash} \menge{NP}]} [he didn't think of, roof]]]
\end{forest}    
