...
of its head, much work employs a \textsc{slash} Inheritance Principle, which
...
\begin{exe} \ex Welsh \begin{xlist} \label{ex:UDC:34}
...
\begin{xlist}
  \ex{\gll Er hat [ein Buch [über die Theorie \_$_i$ ]]
    ...
    he has a book(\textsc{n}) about the theory(\textsc{f)} {} {} read {which.\textsc{f}} currently controversially discussed is\\
...
\ex{\gll Er hat [ein Buch [über
    ...
    he has a book(\textsc{n}) about the theory(\textsc{f}) {} {} stolen {which.\textsc{f}} currently controversially discussed is\\
