...
relative \emph{that}.\footnote{This is the approach that is taken to
  zero relatives in Modern Standard \ili{Arabic} in \citet{Alqurashi:Borsley:12}.}
...
\ili{Arabic}, a \emph{wh}"=interrogative may be realised ex situ, as in
...
\ili{Coptic} \ili{Egyptian}, where \emph{wh} in situ is the norm. They observe that the
