...
\inlinetodoopt{Stefan: \citet{Crysmann2012b-u} calls it \type{index-local} not \type{weak-local}.}
...
\caption{\label{fig:local}Hierarchy of \textit{local} \citep[\page 61]{Crysmann:12}}
