...
type \citep[sec.~10.3.2]{Mueller99a}.
...
including adverbs and NPs \citealp[see][for examples]{Mueller99a,Mueller2002b}.
...
\citet{Keller:95} and \citet{Mueller99a}
...
dependencies, which are realised as extraposed daughters.\footnote{We
  ...
  extraposition. See \citet{Keller:95} for details.}
\begin{exe}
...
\begin{exe}
  ...
  \label{ex:ExtraAdj}
  \begin{xlist}
    \ex[*]{\gll Hier habe ich [bei [den Beobachtungen \_$_i$ ]] faul
      auf der
      Wiese gelegen, [daß die Erde rund ist]$_i$.\\
      here have I during the observations {} {} lazily on the lawn
      laid that the
      earth round is\\
      \glt `I was lying here lazily on the lawn during the
      observations that the world is a sphere.'
      \hfill\citep[283]{kiss_t02nllt}}
   \ex[]{\gll Hier habe ich [bei [vielen Versuchen$_i$ ]] faul auf der
    Wiese gelegen, bei denen$_i$ die Schwerkraft überwunden
    wurde. \\
    here have I during many attempts {} {}  lazily on the lawn laid during which  the gravity overcome was\\
...
description language assumed by Kiss' approach.}
 \footnote{\citet{crysmann_b04rlc} proposes to synthesise the
