...
\gll Shíl mé goN mbeadh sé ann.\\
     thought I \textsc{prt} {would be} he there\\
...
or accusative NP \citep{Bausewein90}. This looks like a problem for
...
free-relative rule.\footnote{\citet{Mueller:99a} pursues a rather
  different approach to free relatives: in order to reconcile
  mismatches between the case requirement that is internal to the
  relative clause and the one that is selected for the free relative
  as a whole, he suggests a unary schema that mediates between the
  different case requirements.}%
