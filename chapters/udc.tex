...
\ChapterDOI{10.5281/zenodo.13644930}
...
\author{Robert D. Borsley\orcid{0000-0002-4856-4732}\affiliation{University of Essex and Bangor University} and Berthold Crysmann\orcid{0000-0003-0230-502X}\affiliation{Centre national de la recherche scientifique (CNRS)}}
...
\gll Pa    ddyn werthodd               Ieuan y   ceffyl iddo             \textnobf{fo}?\\
     which man  sell.\textsc{past.3sg} Ieuan the horse  to\textsc{.3sg.m} he\\\hfill(\ili{Welsh})
...
(\ref{ex:UDC:12}):
\ea
\label{ex:UDC:12}\label{ex:UDC:representation-of-gaps}
...
processing matter, see \citet[Section~3]{Chaves:12} and \crossrefchaptert[Section~\ref{sec-freezing}]{islands} for discussion.
...
empty categories, often called traces, which realise a lexical entry
with no phonology. Either way, they have the feature makeup in
(\ref{ex:UDC:representation-of-gaps}). There is a third possibility
...
this view, the VP will have the structure in Figure~\ref{fig:UDC:21}.
...
\largerpage
\noindent
However, \citet{hukari.levine:adjunct} show that such examples may display
...
\largerpage
\noindent
This is a default\is{default} constraint, as indicated by the `$\slash$'\is{$\slash$}. Essentially,
...
is standardly said to be a case of \isi{across-the-board extraction} {\citep[Section~4.2.4.1]{Ross67a,Williams78a}}. (\ref{ex-which-person-did-you-invite-without-thinking}) is traditionally seen as involving an
...
G.\ \citet[\page 219]{mueller96:_extrap_and_succes_cyclic} show:
...
\end{forest}    
	 \caption{\label{fig:UDC:Tree:ThatHeMightBeWrong}Analysis with a pseudo-filler }
\end{figure}
 
On this analysis, the initial clause is not a filler (it could be
called a pseudo-filler), and the construction is not a head-filler
phrase. However, the analysis involves
