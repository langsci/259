...
\ex[]{What did you put \trace{} on the table?}
    % \ex[]{Who did you talk to \trace{}?}

\ex[*]{You put \trace{} on the table?}
% \ex[*]{You talked to \trace{}.}
...
\ex[]{ {[}\textsubscript{AdvP} How quickly{]} did you do it \trace{} (AdvP)?}
\end{xlist}
\end{exe}
...
\trace{} (NP{[}\textit{sg}{]}) knows the answer?}

\ex[]{ {[}\textsubscript{NP{[}\textit{pl}{]}} Which students{]} do you think \trace{}
...
presence of UD gaps inside a constituent.\footnote{The basic approach
  derives from the earlier Generalised Phrase Structure Grammar (GPSG)
...
\ex \textsc{Beer} I like \trace{}.
\ex To \textsc{London} I went \trace{}.
\end{xlist}
\end{exe}
...
certain kind nominal as the value of \textsc{slash}, which is realised as
...
dependency is head-driven. It is important, therefore, to emphasise
