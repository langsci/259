...
\author{Robert D. Borsley\affiliation{University of Essex and Bangor University}
 \lastand Berthold Crysmann\affiliation{CNRS}
}
...
\itdopt{BC: I suggest to use curved dotted lines with two
  arrowheads. Or otherwise leave it as is. }   
\end{figure}
...
\begin{figure}
  ...
  \itdobl{Redraw with forest, use head-filler-phrase as every where
    else in the paper. Stefan: I can do this.}
...
pronominal argument coindexed with its [\textsc{slash}] value''.\itdopt{What is a ``slashed value''? Its
  ``\SLASH value''? If you change things, please remove quotation marks since it is not a literal
  quote any longer.} \itdopt{BC: Can we not correct an obvious typo? I
marked it with the usual [...] } Consequently,
...
\gll Man hat [die Frau [des Boten \_$_i$]] beschimpft, [der den Befehl überbrachte]$_i$.\footnotemark\\
     one has \spacebr{}the wife \spacebr{}of.the messenger {}  scolded \spacebr{}who the order delivered\\\hfill{(German)}
