...
categories.\footnote{Coordination is a problem for any empty category,
 ...
 \ili{Mauritian} Creole \ili{French} \citep[Chapter~4]{Henri10}. In \ili{Hausa}
...
\gll das Buch, [\textit{das} mich inspirierte]\\
     \textsc{def.n.sg} book(\textsc{n})\textsc{.sg} \hphantom[\textsc{rel.n.sg} me inspired\\
...
\gll das Buch, [[\textit{dessen} / *\textit{deren} Rezension] mir gefiel]\\
     \textsc{def.n.sg} book(\textsc{n})\textsc{.sg} \hphantom{[[}\textsc{rel.n.sg.poss} {} \hphantom{*}\textsc{rel.f.sg.poss} review(\textsc{f}).\textsc{s} me pleased\\
...
%        }
	...
	[synsem & [nonloc|extra & \tag{x} ] \\
         dtrs & [head-dtr & [synsem|nonloc|extra & \{\tag{1} ... \tag{n}\}
         $\cup$ \tag{x}] \\
	 extra-dtrs & < [synsem|loc & \tag{1}] ~... [synsem|loc & \tag{n}]> ] ]
}
...
\added{See also \crossrefchapterw[Section~\ref{cxg:sec-sbcg}]{cxg} for a more general comparison of Constructional HPSG and SBCG.}
