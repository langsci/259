...
Stefan: Very nice. How does this work?
...
Stefan: Wow! Could you explain why tier=2 i needed? What does the ``before drawing tree'' magic do?
...
I cannot figure out what \verb+!r12+ does. I saw the nodes description in the manual once but could
not refind it.

% how to: just draw the tree without multiple inheritance.
% every type will have exactly one subtype
% fin+intrans is a subtype of fin, we need another edge to intrans, which is ??? the root
% node (r)   = !r21
\begin{forest}
  type hierarchy,
%  for level=2{tier=2},
