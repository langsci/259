...
% This is copied from avm+, which I disabled.
...
\begin{forest} type hierarchy
  [object,
    calign=midpoint, calign children={2}{3},
    [\avm{[\asort{substantive} prd & boolean]}
      [\avm{[\asort{verb} vform & vform\\prd & plus]}]
      [\avm{[\asort{noun} case & case]}]
    ]
    [case]
    [vform]
    [boolean
...
\begin{forest} type hierarchy
  [list
    [\avm{[\asort{nelist} first & object\\rest & list]}]
    [elist]
  ]
\end{forest}
