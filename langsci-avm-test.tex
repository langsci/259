...
\item The space between \ibox{1} and NP is larger than the space between bracket and \ibox{1}.
...
\item The brackets used by \verb+\list*+ are the normal text brackets if the content is a single
  line.
% #126
